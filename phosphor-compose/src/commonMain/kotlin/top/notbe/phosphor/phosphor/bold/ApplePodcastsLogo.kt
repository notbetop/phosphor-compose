    ...
    get() {
        ...
        _applePodcastsLogo = Builder(name = "ApplePodcastsLogo", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(107.25f, 107.25f, 0.0f, false, true, -31.77f, 76.5f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -16.94f, -17.0f)
                arcToRelative(84.0f, 84.0f, 0.0f, true, false, -118.58f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -16.94f, 17.0f)
