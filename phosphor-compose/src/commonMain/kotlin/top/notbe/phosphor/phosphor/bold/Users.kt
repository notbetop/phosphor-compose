    ...
    get() {
        ...
        _users = Builder(name = "Users", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(40.0f, 40.0f, 0.0f, true, false, -14.85f, -77.16f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -8.92f, -22.28f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, true, 65.0f, 108.38f)
