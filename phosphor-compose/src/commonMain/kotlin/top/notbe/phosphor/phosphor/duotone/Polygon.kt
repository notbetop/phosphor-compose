...
public val DuotoneGroup.Polygon: ImageVector
    get() {
        if (_polygon != null) {
            return _polygon!!
        }
        _polygon = Builder(name = "Polygon", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(137.0f, 65.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, true, 137.0f, 31.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 137.0f, 65.0f)
                close()
                moveTo(23.0f, 103.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, false, 57.0f, 103.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 23.0f, 103.0f)
                close()
                moveTo(143.0f, 191.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, false, 177.0f, 191.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 143.0f, 191.0f)
                close()
                moveTo(225.0f, 55.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, false, 225.0f, 89.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 225.0f, 55.0f)
                close()
            }
