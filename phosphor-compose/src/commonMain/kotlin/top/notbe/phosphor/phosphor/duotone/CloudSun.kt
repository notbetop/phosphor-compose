...
public val DuotoneGroup.CloudSun: ImageVector
    get() {
        if (_cloudSun != null) {
            return _cloudSun!!
        }
        _cloudSun = Builder(name = "CloudSun", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(131.84f, 84.41f)
                verticalLineToRelative(0.0f)
                arcToRelative(68.22f, 68.22f, 0.0f, false, false, -41.65f, 46.0f)
                verticalLineToRelative(-0.11f)
                arcToRelative(44.08f, 44.08f, 0.0f, false, false, -38.54f, 5.0f)
                horizontalLineToRelative(0.0f)
                arcToRelative(48.0f, 48.0f, 0.0f, true, true, 80.19f, -50.94f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(113.22f, 54.0f)
                arcTo(55.9f, 55.9f, 0.0f, false, false, 88.0f, 48.0f)
                curveToRelative(-0.58f, 0.0f, -1.16f, 0.0f, -1.74f, 0.0f)
                lineTo(83.37f, 31.71f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, false, -15.75f, 2.77f)
                lineTo(70.5f, 50.82f)
                arcTo(56.1f, 56.1f, 0.0f, false, false, 47.23f, 65.67f)
                lineTo(33.61f, 56.14f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, false, -9.17f, 13.11f)
                lineTo(38.0f, 78.77f)
                arcTo(55.55f, 55.55f, 0.0f, false, false, 32.0f, 104.0f)
                curveToRelative(0.0f, 0.57f, 0.0f, 1.15f, 0.0f, 1.72f)
                lineTo(15.71f, 108.6f)
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, true, 48.0f, 104.0f)
                close()
                ...
                arcTo(60.06f, 60.06f, 0.0f, true, true, 156.0f, 208.0f)
                close()
            }
        }
        .build()
