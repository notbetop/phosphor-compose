    ...
    get() {
        ...
        _phoneDisconnect = Builder(name = "PhoneDisconnect", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 84.38f, 142.0f)
                lineTo(35.29f, 159.42f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 26.0f, 157.0f)
                curveToRelative(-14.6f, -18.83f, -13.26f, -43.83f, 4.0f, -61.12f)
                curveToRelative(53.11f, -53.11f, 142.77f, -53.11f, 195.88f, 0.0f)
                curveTo(243.23f, 113.12f, 244.57f, 138.12f, 230.0f, 157.0f)
                close()
            }
