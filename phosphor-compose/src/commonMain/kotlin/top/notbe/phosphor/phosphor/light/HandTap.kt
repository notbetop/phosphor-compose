    ...
    get() {
        ...
        _handTap = Builder(name = "HandTap", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f)
                close()
                moveTo(188.0f, 122.0f)
                arcToRelative(25.87f, 25.87f, 0.0f, false, false, -14.59f, 4.49f)
                arcTo(26.0f, 26.0f, 0.0f, false, false, 134.0f, 110.1f)
                lineTo(134.0f, 76.0f)
                ...
                arcTo(6.0f, 6.0f, 0.0f, false, false, 69.16f, 221.0f)
                lineTo(39.87f, 171.0f)
                ...
                arcTo(5.83f, 5.83f, 0.0f, false, false, 200.0f, 230.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 5.38f, -3.32f)
                curveToRelative(0.35f, -0.7f, 8.63f, -17.55f, 8.63f, -42.68f)
                lineTo(214.01f, 148.0f)
                arcTo(26.0f, 26.0f, 0.0f, false, false, 188.0f, 122.0f)
                close()
            }
        }
        .build()
