...
public val DuotoneGroup.AirTrafficControl: ImageVector
    get() {
        ...
        _airTrafficControl = Builder(name = "AirTrafficControl", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(120.0f, 56.0f)
                lineTo(40.0f, 56.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 25.0f, 77.47f)
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 15.0f, -10.53f)
                lineToRelative(26.19f, -72.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 229.11f, 62.82f)
                close()
                moveTo(110.68f, 144.0f)
                lineTo(97.58f, 72.0f)
                ...
                lineTo(66.18f, 144.0f)
                close()
                moveTo(189.82f, 144.0f)
                lineTo(161.59f, 144.0f)
                lineToRelative(13.09f, -72.0f)
                lineTo(216.0f, 72.0f)
                close()
            }
