    ...
    get() {
        ...
        _cursorText = Builder(name = "CursorText", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(43.86f, 43.86f, 0.0f, false, true, -32.0f, -13.85f)
                arcTo(43.86f, 43.86f, 0.0f, false, true, 96.0f, 220.0f)
                ...
                arcTo(20.0f, 20.0f, 0.0f, false, false, 96.0f, 60.0f)
                horizontalLineTo(80.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, -24.0f)
                horizontalLineTo(96.0f)
                arcToRelative(43.86f, 43.86f, 0.0f, false, true, 32.0f, 13.85f)
                arcTo(43.86f, 43.86f, 0.0f, false, true, 160.0f, 36.0f)
