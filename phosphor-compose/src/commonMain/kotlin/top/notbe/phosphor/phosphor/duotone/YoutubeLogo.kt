...
public val DuotoneGroup.YoutubeLogo: ImageVector
    get() {
        ...
        _youtubeLogo = Builder(name = "YoutubeLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, -9.63f, -11.0f)
                curveTo(183.48f, 47.65f, 128.0f, 48.0f, 128.0f, 48.0f)
                reflectiveCurveToRelative(-55.48f, -0.35f, -89.0f, 12.58f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, -9.63f, 11.0f)
                curveTo(27.07f, 80.54f, 24.0f, 98.09f, 24.0f, 128.0f)
                reflectiveCurveToRelative(3.07f, 47.46f, 5.41f, 56.47f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 39.0f, 195.42f)
                curveTo(72.52f, 208.35f, 128.0f, 208.0f, 128.0f, 208.0f)
                reflectiveCurveToRelative(55.48f, 0.35f, 89.0f, -12.58f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 9.63f, -10.95f)
                curveToRelative(2.34f, -9.0f, 5.41f, -26.56f, 5.41f, -56.47f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-31.65f, 12.22f, -85.48f, 12.0f, -86.12f, 12.0f)
                reflectiveCurveToRelative(-54.37f, 0.18f, -86.0f, -12.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -4.77f, -5.49f)
                ...
                curveTo(73.58f, 55.82f, 127.4f, 56.0f, 128.05f, 56.0f)
                reflectiveCurveToRelative(54.37f, -0.18f, 86.0f, 12.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 4.77f, 5.49f)
