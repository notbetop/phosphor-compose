    ...
    get() {
        ...
        _gauge = Builder(name = "Gauge", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 86.25f, 200.0f)
                ...
                arcTo(8.17f, 8.17f, 0.0f, false, false, 47.73f, 136.0f)
                ...
                arcTo(8.17f, 8.17f, 0.0f, false, false, 136.0f, 79.73f)
                verticalLineTo(52.67f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.43f, -4.0f)
                arcTo(112.18f, 112.18f, 0.0f, false, true, 236.23f, 131.0f)
                ...
                curveTo(240.0f, 157.23f, 240.0f, 158.61f, 240.0f, 160.0f)
                close()
            }
        }
        .build()
