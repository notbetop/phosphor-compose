    ...
    get() {
        ...
        _keyboard = Builder(name = "Keyboard", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(232.0f, 64.49f)
                verticalLineToRelative(127.0f)
                arcToRelative(8.49f, 8.49f, 0.0f, false, true, -8.49f, 8.49f)
                horizontalLineToRelative(-191.0f)
                arcTo(8.49f, 8.49f, 0.0f, false, true, 24.0f, 191.51f)
                verticalLineToRelative(-127.0f)
                arcTo(8.49f, 8.49f, 0.0f, false, true, 32.49f, 56.0f)
                horizontalLineToRelative(191.0f)
                arcTo(8.49f, 8.49f, 0.0f, false, true, 232.0f, 64.49f)
                close()
            }
