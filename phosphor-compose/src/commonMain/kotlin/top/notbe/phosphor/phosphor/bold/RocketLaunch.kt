    ...
    get() {
        ...
        _rocketLaunch = Builder(name = "RocketLaunch", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(100.33f, 201.62f)
                curveTo(91.67f, 213.65f, 74.16f, 228.0f, 40.0f, 228.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -12.0f, -12.0f)
                curveToRelative(0.0f, -34.15f, 14.35f, -51.66f, 26.39f, -60.33f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 14.0f, 19.47f)
                curveToRelative(-6.0f, 4.31f, -12.89f, 12.5f, -15.42f, 27.87f)
                curveToRelative(15.37f, -2.53f, 23.56f, -9.44f, 27.87f, -15.42f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, 19.47f, 14.0f)
                close()
            }
        }
        .build()
