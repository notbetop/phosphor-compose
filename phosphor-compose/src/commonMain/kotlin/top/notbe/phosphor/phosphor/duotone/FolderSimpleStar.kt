...
public val DuotoneGroup.FolderSimpleStar: ImageVector
    get() {
        ...
        _folderSimpleStar = Builder(name = "FolderSimpleStar", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(205.6f, 183.41f)
                lineTo(213.67f, 216.0f)
                lineTo(184.0f, 198.54f)
                lineTo(154.33f, 216.0f)
                lineToRelative(8.07f, -32.59f)
                lineTo(136.0f, 161.61f)
                lineToRelative(34.65f, -2.67f)
                lineTo(184.0f, 128.0f)
                lineToRelative(13.35f, 30.94f)
                lineTo(232.0f, 161.61f)
                close()
            }
