    ...
    get() {
        ...
        _clipboardText = Builder(name = "ClipboardText", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(39.83f, 39.83f, 0.0f, false, false, -8.0f, 24.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(92.26f, 32.0f)
                arcToRelative(47.92f, 47.92f, 0.0f, false, true, 71.48f, 0.0f)
                lineTo(200.0f, 32.0f)
                ...
                close()
                moveTo(200.0f, 48.0f)
                lineTo(173.25f, 48.0f)
                arcTo(47.93f, 47.93f, 0.0f, false, true, 176.0f, 64.0f)
                verticalLineToRelative(8.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, 8.0f)
                lineTo(88.0f, 80.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.0f, -8.0f)
                lineTo(80.0f, 64.0f)
                arcToRelative(47.93f, 47.93f, 0.0f, false, true, 2.75f, -16.0f)
                lineTo(56.0f, 48.0f)
                lineTo(56.0f, 216.0f)
