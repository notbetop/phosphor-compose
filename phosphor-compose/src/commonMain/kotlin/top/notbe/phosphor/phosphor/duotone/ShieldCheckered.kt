    ...
    get() {
        ...
        _shieldCheckered = Builder(name = "ShieldCheckered", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(215.39f, 128.0f)
                curveToRelative(-7.0f, 73.93f, -71.47f, 99.12f, -84.93f, 103.59f)
                arcTo(7.93f, 7.93f, 0.0f, false, true, 128.0f, 232.0f)
                verticalLineTo(128.0f)
                horizontalLineToRelative(87.39f)
                close()
                moveTo(128.0f, 48.0f)
                horizontalLineTo(48.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, 8.0f)
                verticalLineToRelative(58.77f)
                quadToRelative(0.0f, 6.85f, 0.61f, 13.21f)
