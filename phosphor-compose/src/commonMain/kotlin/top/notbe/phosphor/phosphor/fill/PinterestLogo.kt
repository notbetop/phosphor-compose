    ...
    get() {
        ...
        _pinterestLogo = Builder(name = "PinterestLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(60.57f, 60.57f, 0.0f, false, false, 136.0f, 196.0f)
                curveToRelative(37.0f, 0.0f, 66.7f, -33.45f, 63.81f, -73.36f)
                arcTo(72.0f, 72.0f, 0.0f, true, false, 61.24f, 155.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 72.0f, 159.29f)
                arcToRelative(8.19f, 8.19f, 0.0f, false, false, 4.0f, -10.49f)
                arcToRelative(56.0f, 56.0f, 0.0f, true, true, 107.86f, -24.93f)
                curveTo(186.0f, 154.4f, 163.73f, 180.0f, 136.0f, 180.0f)
                ...
                lineTo(85.38f, 217.51f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.71f, 2.59f)
                arcTo(104.0f, 104.0f, 0.0f, false, true, 24.0f, 126.88f)
                curveTo(24.6f, 70.52f, 70.67f, 24.52f, 127.0f, 24.0f)
                arcTo(104.0f, 104.0f, 0.0f, false, true, 232.0f, 128.7f)
                close()
            }
        }
        .build()
