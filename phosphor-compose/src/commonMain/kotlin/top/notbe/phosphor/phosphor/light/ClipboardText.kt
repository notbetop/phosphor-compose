    ...
    get() {
        ...
        _clipboardText = Builder(name = "ClipboardText", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(93.17f, 34.0f)
                arcToRelative(45.91f, 45.91f, 0.0f, false, true, 69.66f, 0.0f)
                lineTo(200.0f, 34.0f)
                ...
                lineTo(170.33f, 46.0f)
                arcTo(45.77f, 45.77f, 0.0f, false, true, 174.0f, 64.0f)
                verticalLineToRelative(8.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.0f, 6.0f)
                lineTo(88.0f, 78.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.0f, -6.0f)
                lineTo(82.0f, 64.0f)
                arcToRelative(45.77f, 45.77f, 0.0f, false, true, 3.67f, -18.0f)
                lineTo(56.0f, 46.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, -2.0f, 2.0f)
                lineTo(54.0f, 216.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, false, 2.0f, 2.0f)
