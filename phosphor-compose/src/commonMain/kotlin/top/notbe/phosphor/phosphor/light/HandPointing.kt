    ...
    get() {
        ...
        _handPointing = Builder(name = "HandPointing", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(26.0f, 26.0f, 0.0f, false, false, 134.0f, 78.1f)
                lineTo(134.0f, 44.0f)
                ...
                lineTo(39.89f, 139.0f)
                lineToRelative(0.0f, 0.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, true, 45.0f, 119.88f)
                arcTo(13.87f, 13.87f, 0.0f, false, true, 52.0f, 118.0f)
