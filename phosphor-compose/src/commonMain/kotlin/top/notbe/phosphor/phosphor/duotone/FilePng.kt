...
public val DuotoneGroup.FilePng: ImageVector
    get() {
        if (_filePng != null) {
            return _filePng!!
        }
        _filePng = Builder(name = "FilePng", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(29.45f, 29.45f, 0.0f, false, true, 16.48f, 5.11f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -9.0f, 13.27f)
                arcTo(13.21f, 13.21f, 0.0f, false, false, 200.0f, 160.0f)
                curveToRelative(-8.82f, 0.0f, -16.0f, 9.0f, -16.0f, 20.0f)
                reflectiveCurveToRelative(7.18f, 20.0f, 16.0f, 20.0f)
                arcToRelative(13.57f, 13.57f, 0.0f, false, false, 8.0f, -2.72f)
                ...
                verticalLineToRelative(56.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.56f, 7.62f)
                arcTo(7.91f, 7.91f, 0.0f, false, true, 148.0f, 216.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.51f, -3.35f)
                lineTo(116.0f, 177.0f)
                verticalLineToRelative(31.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f)
                lineTo(100.0f, 152.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 14.51f, -4.65f)
                lineTo(140.0f, 183.0f)
