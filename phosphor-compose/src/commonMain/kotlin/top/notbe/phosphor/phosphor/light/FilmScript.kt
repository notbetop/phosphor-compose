...
public val LightGroup.FilmScript: ImageVector
    get() {
        if (_filmScript != null) {
            return _filmScript!!
        }
        _filmScript = Builder(name = "FilmScript", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(94.0f, 80.0f)
                arcTo(10.0f, 10.0f, 0.0f, true, true, 84.0f, 70.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 94.0f, 80.0f)
                close()
                moveTo(94.0f, 176.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 94.0f, 176.0f)
                close()
                moveTo(94.0f, 128.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
