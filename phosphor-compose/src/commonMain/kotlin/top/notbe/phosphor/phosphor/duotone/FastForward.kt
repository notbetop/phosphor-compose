    ...
    get() {
        ...
        _fastForward = Builder(name = "FastForward", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(7.76f, 7.76f, 0.0f, false, true, 136.0f, 128.0f)
                close()
                moveTo(236.37f, 121.41f)
                lineTo(148.18f, 65.26f)
                arcTo(7.91f, 7.91f, 0.0f, false, false, 136.0f, 71.85f)
                verticalLineToRelative(112.3f)
                arcToRelative(7.91f, 7.91f, 0.0f, false, false, 12.18f, 6.59f)
                lineToRelative(88.19f, -56.15f)
                arcTo(7.8f, 7.8f, 0.0f, false, false, 236.37f, 121.41f)
                close()
            }
