    ...
    get() {
        ...
        _translate = Builder(name = "Translate", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(242.73f, 210.63f)
                lineToRelative(-56.0f, -112.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -21.46f, 0.0f)
                lineToRelative(-20.52f, 41.0f)
                arcTo(84.2f, 84.2f, 0.0f, false, true, 106.0f, 126.22f)
                arcTo(107.48f, 107.48f, 0.0f, false, false, 131.33f, 68.0f)
                ...
                arcTo(83.69f, 83.69f, 0.0f, false, true, 88.0f, 110.35f)
                arcTo(84.0f, 84.0f, 0.0f, false, true, 75.6f, 91.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, false, -21.81f, 10.0f)
                arcTo(107.55f, 107.55f, 0.0f, false, false, 70.0f, 126.24f)
                arcTo(83.54f, 83.54f, 0.0f, false, true, 24.0f, 140.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, 24.0f)
