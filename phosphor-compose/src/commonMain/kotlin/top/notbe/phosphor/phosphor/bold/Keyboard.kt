    ...
    get() {
        ...
        _keyboard = Builder(name = "Keyboard", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(223.51f, 44.0f)
                horizontalLineToRelative(-191.0f)
                arcTo(20.51f, 20.51f, 0.0f, false, false, 12.0f, 64.49f)
                verticalLineToRelative(127.0f)
                arcTo(20.51f, 20.51f, 0.0f, false, false, 32.49f, 212.0f)
                horizontalLineToRelative(191.0f)
                arcTo(20.51f, 20.51f, 0.0f, false, false, 244.0f, 191.51f)
                verticalLineToRelative(-127.0f)
                arcTo(20.51f, 20.51f, 0.0f, false, false, 223.51f, 44.0f)
                close()
