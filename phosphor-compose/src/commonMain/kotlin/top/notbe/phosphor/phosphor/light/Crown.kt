...
public val LightGroup.Crown: ImageVector
    get() {
        if (_crown != null) {
            return _crown!!
        }
        _crown = Builder(name = "Crown", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(10.16f, 10.16f, 0.0f, false, false, 13.18f, -3.83f)
                ...
                close()
                moveTo(173.91f, 156.45f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -5.9f, 5.0f)
                arcToRelative(6.2f, 6.2f, 0.0f, false, true, -1.0f, -0.09f)
                arcToRelative(230.26f, 230.26f, 0.0f, false, false, -77.92f, 0.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 87.0f, 149.5f)
                arcToRelative(242.36f, 242.36f, 0.0f, false, true, 82.08f, 0.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 173.91f, 156.45f)
                close()
            }
        }
        .build()
