    ...
    get() {
        ...
        _heartBreak = Builder(name = "HeartBreak", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(128.0f, 50.66f)
                lineToRelative(-3.33f, -3.33f)
                arcTo(66.0f, 66.0f, 0.0f, false, false, 12.0f, 94.0f)
                curveToRelative(0.0f, 72.34f, 105.81f, 130.14f, 110.31f, 132.57f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 11.38f, 0.0f)
                curveTo(138.19f, 224.14f, 244.0f, 166.34f, 244.0f, 94.0f)
                arcTo(66.08f, 66.08f, 0.0f, false, false, 178.0f, 28.0f)
                close()
                moveTo(172.51f, 170.36f)
                arcTo(328.69f, 328.69f, 0.0f, false, true, 128.0f, 202.16f)
                ...
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 0.0f, -17.0f)
                lineTo(129.0f, 83.63f)
                lineTo(148.3f, 64.3f)
                arcTo(42.0f, 42.0f, 0.0f, false, true, 220.0f, 94.0f)
                curveTo(220.0f, 123.42f, 194.18f, 151.77f, 172.51f, 170.36f)
                close()
            }
        }
        .build()
