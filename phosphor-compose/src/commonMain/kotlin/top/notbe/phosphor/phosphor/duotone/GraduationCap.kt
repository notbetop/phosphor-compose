...
public val DuotoneGroup.GraduationCap: ImageVector
    get() {
        ...
        _graduationCap = Builder(name = "GraduationCap", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.0f, 113.07f)
                verticalLineToRelative(53.22f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -2.0f, 5.31f)
                curveToRelative(-11.3f, 12.59f, -38.9f, 36.4f, -86.0f, 36.4f)
                reflectiveCurveToRelative(-74.68f, -23.81f, -86.0f, -36.4f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -2.0f, -5.31f)
