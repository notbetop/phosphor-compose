    ...
    get() {
        ...
        _wallet = Builder(name = "Wallet", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(56.0f, 42.0f)
                arcTo(22.0f, 22.0f, 0.0f, false, false, 34.0f, 64.0f)
                lineTo(34.0f, 192.0f)
                ...
                lineTo(46.0f, 83.59f)
                arcTo(21.84f, 21.84f, 0.0f, false, false, 56.0f, 86.0f)
                lineTo(216.0f, 86.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, 2.0f)
                close()
                moveTo(190.0f, 140.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 190.0f, 140.0f)
                close()
            }
        }
        .build()
