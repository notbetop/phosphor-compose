    ...
    get() {
        ...
        _numberCircleEight = Builder(name = "NumberCircleEight", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(142.9f, 123.69f)
                arcToRelative(28.0f, 28.0f, 0.0f, true, false, -29.8f, 0.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, 29.8f, 0.0f)
                close()
                moveTo(108.0f, 100.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, true, 20.0f, 20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 108.0f, 100.0f)
                close()
