...
public val LightGroup.ArrowSquareDownRight: ImageVector
    get() {
        if (_arrowSquareDownRight != null) {
            return _arrowSquareDownRight!!
        }
        _arrowSquareDownRight = Builder(name = "ArrowSquareDownRight", defaultWidth = 256.0.dp,
