...
public val BoldGroup.CaretCircleUpDown: ImageVector
    get() {
        ...
        _caretCircleUpDown = Builder(name = "CaretCircleUpDown", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(168.49f, 143.51f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, 17.0f)
                lineToRelative(-32.0f, 32.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -17.0f, 0.0f)
                lineToRelative(-32.0f, -32.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 17.0f, -17.0f)
                lineTo(128.0f, 167.0f)
                lineToRelative(23.51f, -23.52f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 168.49f, 143.51f)
                close()
            }
        }
        .build()
