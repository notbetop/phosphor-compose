...
public val RegularGroup.GearFine: ImageVector
    get() {
        if (_gearFine != null) {
            return _gearFine!!
        }
        _gearFine = Builder(name = "GearFine", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(128.0f, 56.0f)
                arcToRelative(72.08f, 72.08f, 0.0f, false, true, 71.54f, 64.0f)
                lineTo(132.62f, 120.0f)
                lineTo(99.16f, 62.05f)
                arcTo(71.58f, 71.58f, 0.0f, false, true, 128.0f, 56.0f)
                close()
                moveTo(56.0f, 128.0f)
                arcTo(72.0f, 72.0f, 0.0f, false, true, 85.31f, 70.06f)
                lineTo(118.76f, 128.0f)
                lineTo(85.31f, 185.94f)
                arcTo(72.0f, 72.0f, 0.0f, false, true, 56.0f, 128.0f)
                close()
