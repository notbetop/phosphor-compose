    ...
    get() {
        ...
        _cardholder = Builder(name = "Cardholder", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, -13.71f, 11.21f)
                arcToRelative(26.0f, 26.0f, 0.0f, false, true, -51.0f, 0.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 88.81f, 114.0f)
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, 1.59f)
                arcToRelative(38.0f, 38.0f, 0.0f, false, false, 74.48f, 0.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.95f, -1.59f)
                horizontalLineTo(218.0f)
