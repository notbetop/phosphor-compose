...
public val BoldGroup.PersonSimpleBike: ImageVector
    get() {
        ...
        _personSimpleBike = Builder(name = "PersonSimpleBike", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(42.0f, 42.0f, 0.0f, false, false, 202.0f, 136.0f)
                close()
                moveTo(202.0f, 196.0f)
                arcToRelative(18.0f, 18.0f, 0.0f, true, true, 18.0f, -18.0f)
                arcTo(18.0f, 18.0f, 0.0f, false, true, 202.0f, 196.0f)
                close()
                moveTo(54.0f, 136.0f)
                arcToRelative(42.0f, 42.0f, 0.0f, true, false, 42.0f, 42.0f)
