...
public val BoldGroup.DiceSix: ImageVector
    get() {
        if (_diceSix != null) {
            return _diceSix!!
        }
        _diceSix = Builder(name = "DiceSix", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(112.0f, 84.0f)
                arcTo(16.0f, 16.0f, 0.0f, true, true, 96.0f, 68.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 112.0f, 84.0f)
                close()
                moveTo(176.0f, 84.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 176.0f, 84.0f)
                close()
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 176.0f, 172.0f)
                close()
            }
        }
        .build()
