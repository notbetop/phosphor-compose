...
public val DuotoneGroup.Database: ImageVector
    get() {
        if (_database != null) {
            return _database!!
        }
        _database = Builder(name = "Database", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.0f, 80.0f)
                curveToRelative(0.0f, 26.51f, -39.4f, 48.0f, -88.0f, 48.0f)
                reflectiveCurveTo(40.0f, 106.51f, 40.0f, 80.0f)
                reflectiveCurveToRelative(39.4f, -48.0f, 88.0f, -48.0f)
                reflectiveCurveTo(216.0f, 53.49f, 216.0f, 80.0f)
                close()
            }
