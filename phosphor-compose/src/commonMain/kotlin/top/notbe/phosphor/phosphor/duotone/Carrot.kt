...
public val DuotoneGroup.Carrot: ImageVector
    get() {
        if (_carrot != null) {
            return _carrot!!
        }
        _carrot = Builder(name = "Carrot", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(183.6f, 151.6f)
                curveTo(144.0f, 192.0f, 43.81f, 223.0f, 43.81f, 223.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 33.0f, 212.19f)
                reflectiveCurveTo(64.0f, 112.0f, 104.4f, 72.4f)
