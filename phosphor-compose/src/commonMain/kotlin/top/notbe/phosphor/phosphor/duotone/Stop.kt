    ...
    get() {
        ...
        _stop = Builder(name = "Stop", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(208.0f, 55.27f)
                verticalLineTo(200.73f)
                arcToRelative(7.28f, 7.28f, 0.0f, false, true, -7.27f, 7.27f)
                horizontalLineTo(55.27f)
                arcTo(7.28f, 7.28f, 0.0f, false, true, 48.0f, 200.73f)
                verticalLineTo(55.27f)
                arcTo(7.28f, 7.28f, 0.0f, false, true, 55.27f, 48.0f)
                horizontalLineTo(200.73f)
                arcTo(7.28f, 7.28f, 0.0f, false, true, 208.0f, 55.27f)
                close()
            }
