    ...
    get() {
        ...
        _bugDroid = Builder(name = "BugDroid", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(197.35f, 43.62f)
                lineToRelative(11.14f, -11.13f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -17.0f, -17.0f)
                lineTo(179.34f, 27.69f)
                arcToRelative(91.84f, 91.84f, 0.0f, false, false, -102.68f, 0.0f)
                lineTo(64.49f, 15.51f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -17.0f, 17.0f)
                lineTo(58.65f, 43.62f)
                arcTo(91.58f, 91.58f, 0.0f, false, false, 36.0f, 104.0f)
                verticalLineToRelative(40.0f)
                arcToRelative(92.0f, 92.0f, 0.0f, false, false, 184.0f, 0.0f)
                verticalLineTo(104.0f)
                arcTo(91.58f, 91.58f, 0.0f, false, false, 197.35f, 43.62f)
                close()
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, true, 140.0f, 80.0f)
                close()
                moveTo(84.0f, 80.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, 16.0f, 16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 84.0f, 80.0f)
                close()
            }
        }
        .build()
