...
public val DuotoneGroup.ShareFat: ImageVector
    get() {
        if (_shareFat != null) {
            return _shareFat!!
        }
        _shareFat = Builder(name = "ShareFat", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(-61.4f, 0.0f, -104.61f, 37.19f, -121.07f, 54.72f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -6.9f, -3.18f)
                curveTo(31.51f, 130.45f, 99.19f, 80.0f, 152.0f, 80.0f)
