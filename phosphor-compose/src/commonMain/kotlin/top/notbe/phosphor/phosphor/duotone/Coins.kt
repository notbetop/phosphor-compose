    ...
    get() {
        ...
        _coins = Builder(name = "Coins", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 19.88f, -35.82f, 36.0f, -80.0f, 36.0f)
                curveToRelative(-19.6f, 0.0f, -37.56f, -3.17f, -51.47f, -8.44f)
                horizontalLineToRelative(0.0f)
                curveTo(146.76f, 156.85f, 176.0f, 142.0f, 176.0f, 124.0f)
                verticalLineTo(96.72f)
                horizontalLineToRelative(0.0f)
                curveTo(212.52f, 100.06f, 240.0f, 114.58f, 240.0f, 132.0f)
                close()
                moveTo(176.0f, 84.0f)
                curveToRelative(0.0f, -19.88f, -35.82f, -36.0f, -80.0f, -36.0f)
                reflectiveCurveTo(16.0f, 64.12f, 16.0f, 84.0f)
                reflectiveCurveToRelative(35.82f, 36.0f, 80.0f, 36.0f)
                reflectiveCurveTo(176.0f, 103.88f, 176.0f, 84.0f)
                close()
            }
