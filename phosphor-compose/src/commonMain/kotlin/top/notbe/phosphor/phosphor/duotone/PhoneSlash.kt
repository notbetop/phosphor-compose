...
public val DuotoneGroup.PhoneSlash: ImageVector
    get() {
        if (_phoneSlash != null) {
            return _phoneSlash!!
        }
        _phoneSlash = Builder(name = "PhoneSlash", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(230.0f, 173.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -9.26f, 2.47f)
                lineTo(171.58f, 158.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -4.86f, -5.8f)
                lineToRelative(-6.21f, -29.74f)
                arcToRelative(7.94f, 7.94f, 0.0f, false, false, -5.14f, -5.9f)
                arcToRelative(84.39f, 84.39f, 0.0f, false, false, -55.1f, 0.13f)
                arcToRelative(7.93f, 7.93f, 0.0f, false, false, -5.12f, 6.0f)
                lineToRelative(-5.9f, 29.51f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 84.38f, 158.0f)
                lineTo(35.29f, 175.42f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 26.0f, 173.0f)
                curveToRelative(-14.6f, -18.83f, -13.26f, -43.83f, 4.0f, -61.12f)
                curveToRelative(53.11f, -53.11f, 142.77f, -53.11f, 195.88f, 0.0f)
                curveTo(243.23f, 129.12f, 244.57f, 154.12f, 230.0f, 173.0f)
                close()
            }
