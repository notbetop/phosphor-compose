    ...
    get() {
        ...
        _handPointing = Builder(name = "HandPointing", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, false, 136.0f, 74.7f)
                lineTo(136.0f, 44.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, false, -56.0f, 0.0f)
                verticalLineToRelative(80.0f)
                lineToRelative(-3.82f, -6.13f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 27.73f, 146.0f)
                lineToRelative(4.67f, 8.23f)
                curveTo(66.81f, 214.89f, 81.05f, 240.0f, 128.0f, 240.0f)
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, true, 46.0f, 121.61f)
