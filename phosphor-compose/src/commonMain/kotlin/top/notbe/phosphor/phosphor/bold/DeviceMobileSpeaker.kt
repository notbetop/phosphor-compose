...
public val BoldGroup.DeviceMobileSpeaker: ImageVector
    get() {
        ...
        _deviceMobileSpeaker = Builder(name = "DeviceMobileSpeaker", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(176.0f, 12.0f)
                lineTo(80.0f, 12.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 52.0f, 40.0f)
                lineTo(52.0f, 216.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, false, 28.0f, 28.0f)
                horizontalLineToRelative(96.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, false, 28.0f, -28.0f)
                lineTo(204.0f, 40.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 176.0f, 12.0f)
                close()
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, true, 164.0f, 64.0f)
                close()
            }
        }
        .build()
