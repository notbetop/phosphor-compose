...
public val DuotoneGroup.LineSegments: ImageVector
    get() {
        ...
        _lineSegments = Builder(name = "LineSegments", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(57.0f, 183.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, true, 23.0f, 183.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 57.0f, 183.0f)
                close()
                moveTo(79.0f, 79.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, false, 113.0f, 79.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 79.0f, 79.0f)
                close()
                moveTo(143.0f, 143.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, false, 177.0f, 143.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 143.0f, 143.0f)
                close()
                moveTo(233.0f, 39.0f)
                arcTo(24.0f, 24.0f, 0.0f, true, false, 233.0f, 73.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 233.0f, 39.0f)
                close()
            }
