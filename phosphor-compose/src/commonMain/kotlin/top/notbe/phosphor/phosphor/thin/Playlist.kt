    ...
    get() {
        ...
        _playlist = Builder(name = "Playlist", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, -8.0f)
                close()
                moveTo(243.83f, 125.15f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.0f, 2.68f)
                lineTo(204.0f, 117.38f)
                lineTo(204.0f, 192.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, true, true, -8.0f, -19.57f)
                lineTo(196.0f, 112.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.15f, -3.83f)
                lineToRelative(40.0f, 12.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 243.83f, 125.15f)
                close()
                moveTo(196.0f, 192.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, false, -20.0f, 20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 196.0f, 192.0f)
                close()
            }
        }
        .build()
