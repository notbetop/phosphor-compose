...
public val LightGroup.Presentation: ImageVector
    get() {
        ...
        _presentation = Builder(name = "Presentation", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(83.52f, 190.0f)
                lineTo(59.31f, 220.25f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 9.38f, 7.5f)
                lineTo(98.88f, 190.0f)
                horizontalLineToRelative(58.24f)
                lineToRelative(30.19f, 37.75f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 9.38f, -7.5f)
                lineTo(172.48f, 190.0f)
