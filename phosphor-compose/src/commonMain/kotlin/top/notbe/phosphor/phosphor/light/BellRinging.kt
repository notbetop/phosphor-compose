    ...
    get() {
        ...
        _bellRinging = Builder(name = "BellRinging", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(223.05f, 69.33f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 215.0f, 66.76f)
                arcTo(96.0f, 96.0f, 0.0f, false, false, 180.8f, 29.08f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.4f, -10.15f)
                arcToRelative(109.26f, 109.26f, 0.0f, false, true, 38.41f, 42.31f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 223.05f, 69.33f)
                close()
                moveTo(41.0f, 66.76f)
                arcTo(96.0f, 96.0f, 0.0f, false, true, 75.2f, 29.08f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -6.4f, -10.15f)
                arcTo(109.26f, 109.26f, 0.0f, false, false, 30.39f, 61.24f)
                arcTo(6.0f, 6.0f, 0.0f, true, false, 41.0f, 66.76f)
                close()
                moveTo(220.0f, 176.94f)
                ...
                curveTo(45.13f, 161.09f, 50.0f, 138.63f, 50.0f, 112.0f)
                arcToRelative(78.0f, 78.0f, 0.0f, false, true, 156.0f, 0.0f)
                curveTo(206.0f, 139.0f, 210.74f, 160.86f, 220.08f, 176.94f)
                close()
                moveTo(153.29f, 198.0f)
                lineTo(102.71f, 198.0f)
                arcToRelative(26.0f, 26.0f, 0.0f, false, false, 50.58f, 0.0f)
                close()
                moveTo(209.71f, 183.0f)
                curveTo(199.29f, 165.0f, 194.0f, 141.15f, 194.0f, 112.0f)
