...
public val BoldGroup.SmileyMeh: ImageVector
    get() {
        if (_smileyMeh != null) {
            return _smileyMeh!!
        }
        _smileyMeh = Builder(name = "SmileyMeh", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, true, 180.0f, 160.0f)
                close()
                moveTo(76.0f, 108.0f)
