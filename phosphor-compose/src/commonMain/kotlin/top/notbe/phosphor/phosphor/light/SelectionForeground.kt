...
public val LightGroup.SelectionForeground: ImageVector
    get() {
        ...
        _selectionForeground = Builder(name = "SelectionForeground", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(6.0f, 6.0f, 0.0f, false, true, 62.0f, 216.0f)
                close()
                ...
                arcTo(6.0f, 6.0f, 0.0f, false, false, 40.0f, 166.0f)
                close()
                ...
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, 2.0f)
                verticalLineToRelative(8.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, false, 168.0f, 110.0f)
                close()
                moveTo(56.0f, 82.0f)
                lineTo(48.0f, 82.0f)
                ...
                lineTo(208.0f, 46.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 2.0f, 2.0f)
                lineTo(210.0f, 160.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -2.0f, 2.0f)
                lineTo(174.0f, 162.0f)
                lineTo(174.0f, 144.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -12.0f, 0.0f)
