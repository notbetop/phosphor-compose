    ...
    get() {
        ...
        _wine = Builder(name = "Wine", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(201.5f, 96.8f)
                lineTo(179.72f, 22.87f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 175.89f, 20.0f)
                lineTo(80.11f, 20.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -3.83f, 2.87f)
                lineTo(54.5f, 96.8f)
                arcToRelative(59.51f, 59.51f, 0.0f, false, false, 16.32f, 60.62f)
                arcTo(83.39f, 83.39f, 0.0f, false, false, 124.0f, 179.91f)
                ...
                lineTo(132.0f, 179.91f)
                arcToRelative(83.39f, 83.39f, 0.0f, false, false, 53.18f, -22.49f)
                arcTo(59.51f, 59.51f, 0.0f, false, false, 201.5f, 96.8f)
                close()
                moveTo(83.1f, 28.0f)
                ...
                close()
                moveTo(179.72f, 151.57f)
                arcToRelative(75.68f, 75.68f, 0.0f, false, true, -103.44f, 0.0f)
                arcTo(51.53f, 51.53f, 0.0f, false, true, 62.17f, 99.06f)
                lineToRelative(1.0f, -3.46f)
                curveToRelative(12.66f, -4.87f, 33.45f, -7.0f, 63.0f, 8.0f)
                curveTo(137.0f, 109.0f, 154.33f, 116.0f, 172.8f, 116.0f)
                arcTo(62.78f, 62.78f, 0.0f, false, false, 196.0f, 111.78f)
                arcTo(51.26f, 51.26f, 0.0f, false, true, 179.72f, 151.57f)
                close()
            }
        }
        .build()
