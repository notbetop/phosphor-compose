...
public val DuotoneGroup.Football: ImageVector
    get() {
        if (_football != null) {
            return _football!!
        }
        _football = Builder(name = "Football", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(222.5f, 110.56f)
                curveToRelative(-3.32f, 25.23f, -13.0f, 53.0f, -36.0f, 75.95f)
                reflectiveCurveToRelative(-50.72f, 32.67f, -75.95f, 36.0f)
                horizontalLineToRelative(0.0f)
                lineTo(33.5f, 145.44f)
                horizontalLineToRelative(0.0f)
                curveToRelative(3.32f, -25.23f, 13.0f, -53.0f, 36.0f, -75.95f)
                reflectiveCurveToRelative(50.72f, -32.67f, 76.0f, -36.0f)
                lineToRelative(77.06f, 77.06f)
                close()
            }
