...
public val DuotoneGroup.Heart: ImageVector
    get() {
        if (_heart != null) {
            return _heart!!
        }
        _heart = Builder(name = "Heart", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(22.59f, 0.0f, 41.94f, 12.31f, 50.0f, 32.0f)
                curveToRelative(8.06f, -19.69f, 27.41f, -32.0f, 50.0f, -32.0f)
                arcTo(54.0f, 54.0f, 0.0f, false, true, 232.0f, 94.0f)
                close()
            }
