...
public val DuotoneGroup.Pinwheel: ImageVector
    get() {
        if (_pinwheel != null) {
            return _pinwheel!!
        }
        _pinwheel = Builder(name = "Pinwheel", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(124.88f, 109.74f)
                lineTo(27.15f, 145.33f)
                arcToRelative(52.0f, 52.0f, 0.0f, true, true, 97.73f, -35.59f)
                close()
                moveTo(212.88f, 94.67f)
                lineTo(115.15f, 130.26f)
                arcToRelative(52.0f, 52.0f, 0.0f, true, false, 97.73f, -35.59f)
                close()
            }
