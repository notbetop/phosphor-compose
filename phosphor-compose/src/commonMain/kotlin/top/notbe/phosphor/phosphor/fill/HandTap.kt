    ...
    get() {
        ...
        _handTap = Builder(name = "HandTap", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(168.0f, 120.45f)
                curveToRelative(0.0f, -8.61f, -6.62f, -16.0f, -15.23f, -16.43f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 136.0f, 120.0f)
                verticalLineToRelative(15.73f)
                arcToRelative(8.17f, 8.17f, 0.0f, false, true, -7.47f, 8.25f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.53f, -8.0f)
                lineTo(120.0f, 64.45f)
                curveToRelative(0.0f, -8.61f, -6.62f, -16.0f, -15.23f, -16.43f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 88.0f, 64.0f)
                lineTo(88.0f, 183.74f)
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 26.15f, 168.0f)
                lineToRelative(31.0f, 60.05f)
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 199.23f, 120.0f)
                close()
            }
        }
        .build()
