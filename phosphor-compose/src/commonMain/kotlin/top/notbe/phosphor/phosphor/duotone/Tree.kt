    ...
    get() {
        ...
        _tree = Builder(name = "Tree", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(232.0f, 127.82f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, true, -99.52f, 53.41f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -9.0f, 0.0f)
                arcTo(64.0f, 64.0f, 0.0f, true, true, 61.25f, 69.86f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 4.0f, -4.17f)
                arcToRelative(68.0f, 68.0f, 0.0f, false, true, 125.44f, 0.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 4.0f, 4.17f)
                arcTo(64.0f, 64.0f, 0.0f, false, true, 232.0f, 127.82f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(55.7f, 55.7f, 0.0f, false, true, -32.52f, -9.4f)
                ...
                curveToRelative(-0.31f, 0.18f, -0.62f, 0.37f, -0.92f, 0.57f)
                arcTo(55.73f, 55.73f, 0.0f, false, true, 86.55f, 184.0f)
