...
public val RegularGroup.BugBeetle: ImageVector
    get() {
        if (_bugBeetle != null) {
            return _bugBeetle!!
        }
        _bugBeetle = Builder(name = "BugBeetle", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(19.5f, 19.49f)
                arcTo(79.76f, 79.76f, 0.0f, false, false, 48.4f, 96.0f)
                lineTo(32.0f, 96.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f)
                lineTo(48.0f, 112.0f)
                ...
                arcTo(64.07f, 64.07f, 0.0f, false, true, 128.0f, 40.0f)
                close()
                moveTo(136.0f, 215.48f)
                lineTo(136.0f, 136.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -16.0f, 0.0f)
                verticalLineToRelative(79.48f)
                arcTo(64.07f, 64.07f, 0.0f, false, true, 64.0f, 152.0f)
                lineTo(64.0f, 112.0f)
                lineTo(192.0f, 112.0f)
                verticalLineToRelative(40.0f)
                arcTo(64.07f, 64.07f, 0.0f, false, true, 136.0f, 215.48f)
                close()
            }
        }
        .build()
