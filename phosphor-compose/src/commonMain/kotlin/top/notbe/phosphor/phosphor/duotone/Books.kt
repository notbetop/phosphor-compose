...
public val DuotoneGroup.Books: ImageVector
    get() {
        if (_books != null) {
            return _books!!
        }
        _books = Builder(name = "Books", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(190.64f, 38.39f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -9.5f, -6.21f)
                lineToRelative(-46.81f, 10.0f)
                arcToRelative(8.07f, 8.07f, 0.0f, false, false, -6.15f, 9.57f)
                lineTo(139.79f, 107.0f)
