...
public val BoldGroup.MicrosoftOutlookLogo: ImageVector
    get() {
        ...
        _microsoftOutlookLogo = Builder(name = "MicrosoftOutlookLogo", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(36.0f, 36.0f, 0.0f, false, false, 88.0f, 92.0f)
                close()
                moveTo(88.0f, 140.0f)
                ...
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, -20.0f)
                lineTo(236.0f, 120.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 216.0f, 100.0f)
                close()
