    ...
    get() {
        ...
        _wine = Builder(name = "Wine", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(182.48f, 154.5f)
                arcToRelative(79.77f, 79.77f, 0.0f, false, true, -109.0f, 0.0f)
                arcTo(55.86f, 55.86f, 0.0f, false, true, 58.3f, 97.93f)
                lineToRelative(1.57f, -5.31f)
                horizontalLineToRelative(0.0f)
                curveTo(72.49f, 87.21f, 95.2f, 83.4f, 128.0f, 100.0f)
                curveToRelative(35.86f, 18.16f, 59.67f, 11.89f, 71.42f, 5.84f)
                horizontalLineToRelative(0.0f)
                arcTo(55.72f, 55.72f, 0.0f, false, true, 182.48f, 154.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(205.33f, 95.67f)
                lineTo(183.56f, 21.74f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 175.89f, 16.0f)
                horizontalLineTo(80.11f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.67f, 5.74f)
                lineTo(50.67f, 95.67f)
                arcToRelative(63.46f, 63.46f, 0.0f, false, false, 17.42f, 64.67f)
                arcTo(87.41f, 87.41f, 0.0f, false, false, 120.0f, 183.63f)
                ...
                arcTo(47.2f, 47.2f, 0.0f, false, true, 177.0f, 148.65f)
                close()
            }
        }
        .build()
