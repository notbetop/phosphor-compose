...
public val DuotoneGroup.Goggles: ImageVector
    get() {
        if (_goggles != null) {
            return _goggles!!
        }
        _goggles = Builder(name = "Goggles", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 17.67f, -30.33f, 32.0f, -48.0f, 32.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, 0.0f, -64.0f)
                curveTo(201.67f, 120.0f, 232.0f, 134.33f, 232.0f, 152.0f)
                close()
                moveTo(72.0f, 120.0f)
                curveToRelative(-17.67f, 0.0f, -48.0f, 14.33f, -48.0f, 32.0f)
                reflectiveCurveToRelative(30.33f, 32.0f, 48.0f, 32.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(61.0f, 129.7f)
                arcTo(42.72f, 42.72f, 0.0f, false, true, 72.0f, 128.0f)
