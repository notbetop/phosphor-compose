    ...
    get() {
        ...
        _command = Builder(name = "Command", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(28.0f, 28.0f, 0.0f, false, true, 28.0f, -28.0f)
                horizontalLineToRelative(0.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, true, 208.0f, 76.0f)
                close()
                moveTo(76.0f, 48.0f)
                horizontalLineToRelative(0.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 48.0f, 76.0f)
                horizontalLineToRelative(0.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, false, 28.0f, 28.0f)
                horizontalLineToRelative(28.0f)
                verticalLineTo(76.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 76.0f, 48.0f)
                close()
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, false, 48.0f, 180.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(96.0f, 96.0f)
                lineTo(76.0f, 96.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 56.0f, 76.0f)
                close()
                moveTo(96.0f, 180.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, true, -20.0f, -20.0f)
                lineTo(96.0f, 160.0f)
