...
public val DuotoneGroup.PiggyBank: ImageVector
    get() {
        if (_piggyBank != null) {
            return _piggyBank!!
        }
        _piggyBank = Builder(name = "PiggyBank", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.54f, 5.31f)
                horizontalLineTo(177.64f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.54f, -5.31f)
                lineTo(166.29f, 200.0f)
                horizontalLineTo(97.71f)
                lineTo(93.9f, 210.69f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 86.36f, 216.0f)
                horizontalLineTo(73.64f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.54f, -5.31f)
                lineTo(53.0f, 174.0f)
                arcToRelative(79.7f, 79.7f, 0.0f, false, true, -21.0f, -54.0f)
                horizontalLineToRelative(0.0f)
                arcToRelative(80.0f, 80.0f, 0.0f, false, true, 80.0f, -80.0f)
                horizontalLineToRelative(32.0f)
                arcToRelative(80.0f, 80.0f, 0.0f, false, true, 73.44f, 48.22f)
                arcToRelative(82.22f, 82.22f, 0.0f, false, true, 2.9f, 7.78f)
