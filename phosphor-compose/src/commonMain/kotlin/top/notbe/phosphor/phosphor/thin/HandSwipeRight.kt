...
public val ThinGroup.HandSwipeRight: ImageVector
    get() {
        ...
        _handSwipeRight = Builder(name = "HandSwipeRight", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(24.0f, 24.0f, 0.0f, false, true, 204.0f, 140.0f)
                close()
                moveTo(242.83f, 53.17f)
                lineTo(210.83f, 21.17f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -5.66f, 5.66f)
                lineTo(230.34f, 52.0f)
                lineTo(168.0f, 52.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 0.0f, 8.0f)
                horizontalLineToRelative(62.34f)
                lineTo(205.17f, 85.17f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.66f, 5.66f)
                lineToRelative(32.0f, -32.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 242.83f, 53.17f)
                close()
            }
        }
        .build()
