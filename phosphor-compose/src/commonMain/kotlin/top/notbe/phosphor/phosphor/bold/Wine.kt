    ...
    get() {
        ...
        _wine = Builder(name = "Wine", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(209.17f, 94.54f)
                lineTo(187.39f, 20.61f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 175.89f, 12.0f)
                horizontalLineTo(80.11f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -11.5f, 8.61f)
                lineTo(46.83f, 94.54f)
                arcToRelative(67.45f, 67.45f, 0.0f, false, false, 18.53f, 68.72f)
                arcTo(91.32f, 91.32f, 0.0f, false, false, 116.0f, 187.2f)
                ...
                verticalLineTo(187.2f)
                arcToRelative(91.32f, 91.32f, 0.0f, false, false, 50.65f, -23.94f)
                arcTo(67.45f, 67.45f, 0.0f, false, false, 209.17f, 94.54f)
                close()
                moveTo(89.08f, 36.0f)
                horizontalLineToRelative(77.84f)
                lineTo(185.3f, 98.41f)
                curveToRelative(-10.88f, 2.8f, -28.05f, 3.0f, -51.88f, -9.12f)
                curveTo(110.68f, 77.78f, 91.92f, 75.0f, 77.24f, 76.22f)
                close()
                ...
                arcTo(67.5f, 67.5f, 0.0f, false, true, 128.0f, 164.0f)
                close()
            }
        }
        .build()
