    ...
    get() {
        ...
        _eyedropperSample = Builder(name = "EyedropperSample", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(43.89f, 43.89f, 0.0f, false, false, 39.45f, -12.09f)
                lineToRelative(48.24f, -48.26f)
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, 27.47f, -0.73f)
                lineToRelative(9.0f, -9.0f)
                arcToRelative(28.06f, 28.06f, 0.0f, false, false, 3.25f, -35.71f)
                lineToRelative(17.24f, -17.34f)
                arcTo(39.69f, 39.69f, 0.0f, false, false, 228.0f, 67.24f)
                close()
                moveTo(142.35f, 141.9f)
                lineTo(136.29f, 148.0f)
                lineTo(79.73f, 148.0f)
                lineToRelative(34.34f, -34.36f)
                close()
                ...
                arcTo(20.0f, 20.0f, 0.0f, false, true, 60.41f, 172.0f)
                horizontalLineToRelative(51.88f)
                close()
