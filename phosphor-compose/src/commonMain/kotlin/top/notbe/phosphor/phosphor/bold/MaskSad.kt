    ...
    get() {
        ...
        _maskSad = Builder(name = "MaskSad", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(17.75f, 17.75f, 0.0f, false, false, 19.06f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 13.0f, 20.2f)
                arcToRelative(41.74f, 41.74f, 0.0f, false, true, -45.0f, 0.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 137.89f, 113.51f)
                close()
                moveTo(114.5f, 130.09f)
                arcToRelative(41.72f, 41.72f, 0.0f, false, true, -45.0f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, 13.0f, -20.19f)
                arcToRelative(17.74f, 17.74f, 0.0f, false, false, 19.07f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, 13.0f, 20.19f)
                close()
