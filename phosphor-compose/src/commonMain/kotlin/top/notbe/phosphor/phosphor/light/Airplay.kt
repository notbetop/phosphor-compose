    ...
    get() {
        ...
        _airplay = Builder(name = "Airplay", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(132.56f, 156.1f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -9.11f, 0.0f)
                lineToRelative(-48.0f, 56.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, false, 80.0f, 222.0f)
                horizontalLineToRelative(96.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 4.56f, -9.9f)
                close()
                moveTo(93.05f, 210.0f)
                lineToRelative(35.0f, -40.78f)
                ...
                arcToRelative(22.0f, 22.0f, 0.0f, false, true, -22.0f, -22.0f)
                verticalLineTo(64.0f)
                arcTo(22.0f, 22.0f, 0.0f, false, true, 48.0f, 42.0f)
                horizontalLineTo(208.0f)
                arcTo(22.0f, 22.0f, 0.0f, false, true, 230.0f, 64.0f)
                close()
            }
        }
        .build()
