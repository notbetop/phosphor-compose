...
public val FillGroup.TextColumns: ImageVector
    get() {
        if (_textColumns != null) {
            return _textColumns!!
        }
        _textColumns = Builder(name = "TextColumns", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, -8.0f)
                lineTo(120.0f, 64.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 112.0f, 56.0f)
                close()
                moveTo(216.0f, 96.0f)
                lineTo(144.0f, 96.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -8.0f, 8.0f)
