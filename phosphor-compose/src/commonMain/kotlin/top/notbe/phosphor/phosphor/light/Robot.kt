    ...
    get() {
        ...
        _robot = Builder(name = "Robot", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(122.0f, 50.0f)
                lineTo(56.0f, 50.0f)
                arcTo(30.0f, 30.0f, 0.0f, false, false, 26.0f, 80.0f)
                lineTo(26.0f, 192.0f)
                arcToRelative(30.0f, 30.0f, 0.0f, false, false, 30.0f, 30.0f)
                lineTo(200.0f, 222.0f)
                arcToRelative(30.0f, 30.0f, 0.0f, false, false, 30.0f, -30.0f)
                lineTo(230.0f, 80.0f)
                arcTo(30.0f, 30.0f, 0.0f, false, false, 200.0f, 50.0f)
                close()
                ...
                arcToRelative(18.0f, 18.0f, 0.0f, false, true, -18.0f, -18.0f)
                lineTo(38.0f, 80.0f)
                arcTo(18.0f, 18.0f, 0.0f, false, true, 56.0f, 62.0f)
                lineTo(200.0f, 62.0f)
                arcToRelative(18.0f, 18.0f, 0.0f, false, true, 18.0f, 18.0f)
                close()
                ...
                arcToRelative(26.0f, 26.0f, 0.0f, false, false, 0.0f, -52.0f)
                close()
                moveTo(138.0f, 150.0f)
                verticalLineToRelative(28.0f)
                lineTo(118.0f, 178.0f)
                lineTo(118.0f, 150.0f)
                close()
                moveTo(78.0f, 164.0f)
