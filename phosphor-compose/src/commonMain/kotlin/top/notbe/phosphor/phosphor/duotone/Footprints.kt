...
public val DuotoneGroup.Footprints: ImageVector
    get() {
        if (_footprints != null) {
            return _footprints!!
        }
        _footprints = Builder(name = "Footprints", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(76.0f, 24.0f)
                curveToRelative(-24.52f, 0.0f, -51.46f, 80.0f, -25.26f, 112.0f)
                horizontalLineToRelative(50.52f)
                curveTo(127.46f, 104.0f, 100.52f, 24.0f, 76.0f, 24.0f)
                close()
                moveTo(205.26f, 160.0f)
                curveToRelative(26.2f, -32.0f, -0.74f, -112.0f, -25.26f, -112.0f)
                reflectiveCurveToRelative(-51.46f, 80.0f, -25.26f, 112.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(10.81f, 6.22f, 17.29f, 19.89f)
                curveToRelative(11.1f, 23.41f, 15.29f, 58.0f, 3.89f, 76.11f)
