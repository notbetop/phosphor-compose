...
public val DuotoneGroup.WhatsappLogo: ImageVector
    get() {
        ...
        _whatsappLogo = Builder(name = "WhatsappLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(128.0f, 32.0f)
                arcTo(96.0f, 96.0f, 0.0f, false, false, 44.89f, 176.07f)
                lineTo(32.42f, 213.46f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 10.12f, 10.12f)
                ...
                arcToRelative(48.19f, 48.19f, 0.0f, false, false, 25.85f, 25.85f)
                lineTo(152.0f, 136.0f)
                lineToRelative(32.0f, 16.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, true, 152.0f, 184.0f)
                close()
            }
