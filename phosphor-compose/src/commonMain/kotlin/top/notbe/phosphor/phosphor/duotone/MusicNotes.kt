    ...
    get() {
        ...
        _musicNotes = Builder(name = "MusicNotes", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, true, 208.0f, 172.0f)
                close()
                moveTo(52.0f, 176.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, true, false, 28.0f, 28.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 52.0f, 176.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(212.92f, 25.69f)
                ...
                verticalLineTo(174.08f)
                arcTo(36.0f, 36.0f, 0.0f, true, false, 88.0f, 204.0f)
                verticalLineTo(118.25f)
                lineToRelative(112.0f, -28.0f)
                verticalLineToRelative(51.83f)
                arcTo(36.0f, 36.0f, 0.0f, true, false, 216.0f, 172.0f)
                verticalLineTo(32.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 212.92f, 25.69f)
                close()
                moveTo(52.0f, 224.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, true, 20.0f, -20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 52.0f, 224.0f)
                close()
                moveTo(88.0f, 101.75f)
                verticalLineTo(70.25f)
                lineToRelative(112.0f, -28.0f)
                verticalLineToRelative(31.5f)
                close()
                moveTo(180.0f, 192.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, true, 20.0f, -20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, true, 180.0f, 192.0f)
                close()
            }
        }
        .build()
