...
public val DuotoneGroup.Megaphone: ImageVector
    get() {
        if (_megaphone != null) {
            return _megaphone!!
        }
        _megaphone = Builder(name = "Megaphone", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, true, 232.0f, 120.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 151.12f, 214.0f)
                lineToRelative(11.0f, 7.33f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 186.5f, 212.0f)
                lineToRelative(11.77f, -44.36f)
                arcTo(48.07f, 48.07f, 0.0f, false, false, 240.0f, 120.0f)
                close()
                moveTo(40.0f, 199.93f)
                lineTo(40.0f, 40.0f)
                horizontalLineToRelative(0.0f)
                curveToRelative(42.81f, 35.91f, 86.63f, 45.0f, 104.0f, 47.24f)
                verticalLineToRelative(65.48f)
                curveTo(126.65f, 155.0f, 82.84f, 164.07f, 40.0f, 199.93f)
                close()
                moveTo(171.0f, 207.93f)
                lineTo(171.0f, 208.04f)
                lineTo(160.0f, 200.71f)
