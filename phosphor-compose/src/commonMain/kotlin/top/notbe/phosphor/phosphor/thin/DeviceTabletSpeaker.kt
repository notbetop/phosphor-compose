...
public val ThinGroup.DeviceTabletSpeaker: ImageVector
    get() {
        ...
        _deviceTabletSpeaker = Builder(name = "DeviceTabletSpeaker", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(192.0f, 28.0f)
                lineTo(64.0f, 28.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 44.0f, 48.0f)
                lineTo(44.0f, 208.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, 20.0f)
                lineTo(192.0f, 228.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, -20.0f)
                lineTo(212.0f, 48.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 192.0f, 28.0f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 164.0f, 64.0f)
                close()
            }
        }
        .build()
