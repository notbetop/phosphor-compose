...
public val DuotoneGroup.Dna: ImageVector
    get() {
        if (_dna != null) {
            return _dna!!
        }
        _dna = Builder(name = "Dna", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(103.8f, 140.1f)
                lineTo(128.0f, 128.0f)
                lineToRelative(24.2f, 12.1f)
                arcTo(72.0f, 72.0f, 0.0f, false, true, 192.0f, 204.5f)
                verticalLineTo(208.0f)
                horizontalLineTo(64.0f)
                verticalLineToRelative(-3.5f)
                arcTo(72.0f, 72.0f, 0.0f, false, true, 103.8f, 140.1f)
                close()
                moveTo(192.0f, 51.5f)
                verticalLineTo(48.0f)
                horizontalLineTo(64.0f)
                verticalLineToRelative(3.5f)
                arcToRelative(72.0f, 72.0f, 0.0f, false, false, 39.8f, 64.4f)
                lineTo(128.0f, 128.0f)
                lineToRelative(24.2f, -12.1f)
                arcTo(72.0f, 72.0f, 0.0f, false, false, 192.0f, 51.5f)
                close()
            }
