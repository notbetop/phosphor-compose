...
public val RegularGroup.Coin: ImageVector
    get() {
        if (_coin != null) {
            return _coin!!
        }
        _coin = Builder(name = "Coin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(128.0f, 64.0f)
                curveToRelative(62.64f, 0.0f, 96.0f, 23.23f, 96.0f, 40.0f)
                reflectiveCurveToRelative(-33.36f, 40.0f, -96.0f, 40.0f)
                reflectiveCurveToRelative(-96.0f, -23.23f, -96.0f, -40.0f)
                reflectiveCurveTo(65.36f, 64.0f, 128.0f, 64.0f)
                close()
                moveTo(120.0f, 159.86f)
