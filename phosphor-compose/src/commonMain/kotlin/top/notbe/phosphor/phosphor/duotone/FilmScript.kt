...
public val DuotoneGroup.FilmScript: ImageVector
    get() {
        if (_filmScript != null) {
            return _filmScript!!
        }
        _filmScript = Builder(name = "FilmScript", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(96.0f, 80.0f)
                arcTo(12.0f, 12.0f, 0.0f, true, true, 84.0f, 68.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 96.0f, 80.0f)
                close()
                moveTo(96.0f, 176.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -12.0f, -12.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 96.0f, 176.0f)
                close()
                moveTo(96.0f, 128.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -12.0f, -12.0f)
