...
public val LightGroup.HardDrives: ImageVector
    get() {
        if (_hardDrives != null) {
            return _hardDrives!!
        }
        _hardDrives = Builder(name = "HardDrives", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(10.0f, 10.0f, 0.0f, false, true, 190.0f, 80.0f)
                close()
                moveTo(190.0f, 176.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 190.0f, 176.0f)
                close()
            }
        }
        .build()
