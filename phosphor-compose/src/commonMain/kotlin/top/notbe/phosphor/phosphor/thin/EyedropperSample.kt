    ...
    get() {
        ...
        _eyedropperSample = Builder(name = "EyedropperSample", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(31.8f, 31.8f, 0.0f, false, false, -10.0f, -22.82f)
                ...
                arcToRelative(35.92f, 35.92f, 0.0f, false, false, 34.59f, -9.37f)
                ...
                arcTo(31.76f, 31.76f, 0.0f, false, false, 220.0f, 67.37f)
                close()
                ...
                arcToRelative(27.93f, 27.93f, 0.0f, false, true, 1.22f, -21.0f)
                lineTo(131.6f, 163.97f)
                close()
                moveTo(139.6f, 156.0f)
                lineTo(60.41f, 156.0f)
                lineToRelative(53.65f, -53.67f)
                lineToRelative(39.6f, 39.61f)
                close()
                moveTo(179.6f, 110.34f)
