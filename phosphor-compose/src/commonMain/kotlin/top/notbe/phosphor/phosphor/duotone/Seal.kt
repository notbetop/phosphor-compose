...
public val DuotoneGroup.Seal: ImageVector
    get() {
        if (_seal != null) {
            return _seal!!
        }
        _seal = Builder(name = "Seal", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(-4.68f, 11.32f, 1.42f, 30.64f, -7.78f, 39.85f)
                ...
                curveToRelative(-11.32f, -4.68f, -30.64f, 1.42f, -39.85f, -7.78f)
                ...
                curveTo(51.36f, 83.0f, 45.26f, 63.67f, 54.46f, 54.46f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(146.27f, 23.51f, 138.44f, 16.0f, 128.0f, 16.0f)
                ...
                curveTo(23.51f, 109.73f, 16.0f, 117.56f, 16.0f, 128.0f)
                ...
                curveToRelative(5.25f, 0.08f, 10.67f, 0.16f, 13.94f, 1.52f)
                curveToRelative(3.57f, 1.47f, 7.63f, 5.37f, 11.57f, 9.14f)
                curveTo(109.73f, 232.49f, 117.56f, 240.0f, 128.0f, 240.0f)
                reflectiveCurveToRelative(18.27f, -7.51f, 25.18f, -14.14f)
                curveToRelative(3.94f, -3.77f, 8.0f, -7.67f, 11.57f, -9.14f)
                ...
                curveToRelative(0.08f, -5.25f, 0.16f, -10.67f, 1.52f, -13.94f)
                curveToRelative(1.47f, -3.57f, 5.37f, -7.63f, 9.14f, -11.57f)
                curveTo(232.49f, 146.27f, 240.0f, 138.44f, 240.0f, 128.0f)
                ...
                reflectiveCurveToRelative(-9.14f, -4.92f, -14.11f, -9.69f)
                ...
                curveToRelative(-3.11f, -3.1f, -3.22f, -10.39f, -3.32f, -17.43f)
                ...
                reflectiveCurveToRelative(4.92f, -9.14f, 9.69f, -14.11f)
                ...
                reflectiveCurveTo(219.08f, 137.14f, 214.31f, 142.11f)
                close()
            }
        }
        .build()
