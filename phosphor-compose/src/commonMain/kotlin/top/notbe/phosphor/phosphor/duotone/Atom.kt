...
public val DuotoneGroup.Atom: ImageVector
    get() {
        if (_atom != null) {
            return _atom!!
        }
        _atom = Builder(name = "Atom", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(210.26f, 210.26f)
                curveToRelative(-17.23f, 17.23f, -68.0f, -5.63f, -113.46f, -51.06f)
                reflectiveCurveTo(28.51f, 63.0f, 45.74f, 45.74f)
                reflectiveCurveToRelative(68.0f, 5.63f, 113.46f, 51.06f)
                reflectiveCurveTo(227.49f, 193.0f, 210.26f, 210.26f)
                close()
            }
