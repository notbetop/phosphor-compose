...
public val DuotoneGroup.WebhooksLogo: ImageVector
    get() {
        ...
        _webhooksLogo = Builder(name = "WebhooksLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, false, 192.0f, 136.0f)
                close()
                moveTo(64.0f, 136.0f)
                arcToRelative(40.0f, 40.0f, 0.0f, true, false, 40.0f, 40.0f)
                arcTo(40.0f, 40.0f, 0.0f, false, false, 64.0f, 136.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(178.16f, 184.0f)
                lineTo(111.32f, 184.0f)
                arcTo(48.0f, 48.0f, 0.0f, true, true, 25.6f, 147.19f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 12.8f, 9.61f)
                arcTo(31.69f, 31.69f, 0.0f, false, false, 32.0f, 176.0f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, true, false, 172.0f, 52.79f)
                arcToRelative(48.0f, 48.0f, 0.0f, true, false, -75.62f, 55.33f)
                lineTo(64.44f, 160.0f)
                ...
                lineTo(142.08f, 79.6f)
                arcTo(16.0f, 16.0f, 0.0f, true, false, 128.0f, 88.0f)
                lineToRelative(0.44f, 0.0f)
                lineToRelative(35.78f, 58.15f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.0f, 2.61f)
                arcTo(32.0f, 32.0f, 0.0f, true, true, 192.0f, 208.0f)
