    ...
    get() {
        ...
        _paperPlaneTilt = Builder(name = "PaperPlaneTilt", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(14.0f, 14.0f, 0.0f, false, false, 18.0f, 110.88f)
                lineToRelative(85.61f, 40.55f)
                arcToRelative(2.08f, 2.08f, 0.0f, false, true, 0.95f, 0.95f)
                ...
                lineToRelative(0.0f, 0.11f)
                arcToRelative(1.88f, 1.88f, 0.0f, false, true, -1.76f, 1.45f)
                arcToRelative(1.86f, 1.86f, 0.0f, false, true, -2.0f, -1.14f)
                lineToRelative(-40.0f, -84.36f)
                lineToRelative(48.24f, -48.24f)
