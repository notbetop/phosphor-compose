...
public val DuotoneGroup.HandCoins: ImageVector
    get() {
        if (_handCoins != null) {
            return _handCoins!!
        }
        _handCoins = Builder(name = "HandCoins", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(204.0f, 56.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, false, -12.0f, 2.71f)
                horizontalLineToRelative(0.0f)
                arcTo(28.0f, 28.0f, 0.0f, true, false, 176.0f, 85.29f)
                horizontalLineToRelative(0.0f)
                arcTo(28.0f, 28.0f, 0.0f, true, false, 204.0f, 56.0f)
                close()
            }
