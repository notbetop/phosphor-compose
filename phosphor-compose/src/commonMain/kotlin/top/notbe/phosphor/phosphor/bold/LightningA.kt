...
public val BoldGroup.LightningA: ImageVector
    get() {
        if (_lightningA != null) {
            return _lightningA!!
        }
        _lightningA = Builder(name = "LightningA", defaultWidth = 256.0.dp, defaultHeight =
