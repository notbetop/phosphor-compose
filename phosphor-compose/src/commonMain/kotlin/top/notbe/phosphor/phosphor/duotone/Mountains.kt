    ...
    get() {
        ...
        _mountains = Builder(name = "Mountains", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(94.9f, 75.94f)
                lineTo(125.65f, 128.0f)
                lineTo(50.35f, 128.0f)
                lineTo(81.1f, 75.94f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 94.9f, 75.94f)
                close()
                moveTo(164.0f, 72.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, false, -20.0f, -20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 164.0f, 72.0f)
                close()
                moveTo(193.44f, 107.92f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -13.77f, 0.0f)
