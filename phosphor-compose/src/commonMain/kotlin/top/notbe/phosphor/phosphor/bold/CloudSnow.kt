    ...
    get() {
        ...
        _cloudSnow = Builder(name = "CloudSnow", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 112.0f, 200.0f)
                close()
                moveTo(64.0f, 200.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, false, 16.0f, 16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 64.0f, 200.0f)
                close()
                moveTo(236.0f, 92.0f)
                arcToRelative(80.09f, 80.09f, 0.0f, false, true, -80.0f, 80.0f)
                lineTo(76.0f, 172.0f)
                arcTo(56.0f, 56.0f, 0.0f, false, true, 76.0f, 60.0f)
                arcToRelative(56.89f, 56.89f, 0.0f, false, true, 6.39f, 0.36f)
