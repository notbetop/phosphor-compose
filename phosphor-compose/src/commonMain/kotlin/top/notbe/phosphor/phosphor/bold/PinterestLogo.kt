    ...
    get() {
        ...
        _pinterestLogo = Builder(name = "PinterestLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(182.52f, 187.57f, 163.33f, 196.0f, 144.0f, 196.0f)
                ...
                curveTo(118.72f, 164.86f, 127.16f, 172.0f, 144.0f, 172.0f)
                curveToRelative(25.56f, 0.0f, 52.0f, -22.45f, 52.0f, -60.0f)
                arcTo(68.0f, 68.0f, 0.0f, true, false, 69.09f, 146.0f)
