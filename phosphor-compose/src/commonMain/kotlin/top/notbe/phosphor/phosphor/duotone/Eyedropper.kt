...
public val DuotoneGroup.Eyedropper: ImageVector
    get() {
        if (_eyedropper != null) {
            return _eyedropper!!
        }
        _eyedropper = Builder(name = "Eyedropper", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(207.8f, 87.6f)
                lineToRelative(-25.37f, 25.53f)
                lineToRelative(4.89f, 4.88f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, 0.0f, 22.64f)
                lineToRelative(-9.0f, 9.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 0.0f)
                lineToRelative(-60.68f, -60.7f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -11.32f)
                lineToRelative(9.0f, -9.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, 22.63f, 0.0f)
                lineToRelative(4.88f, 4.89f)
                lineToRelative(25.0f, -25.11f)
                curveToRelative(10.79f, -10.79f, 28.37f, -11.45f, 39.45f, -1.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, true, 207.8f, 87.6f)
                close()
            }
