    ...
    get() {
        ...
        _microphone = Builder(name = "Microphone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(52.06f, 52.06f, 0.0f, false, false, 128.0f, 172.0f)
                close()
                moveTo(100.0f, 64.0f)
                ...
                arcToRelative(28.0f, 28.0f, 0.0f, false, true, -56.0f, 0.0f)
                close()
                moveTo(140.0f, 211.22f)
                lineTo(140.0f, 232.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f)
                lineTo(116.0f, 211.22f)
                arcTo(92.14f, 92.14f, 0.0f, false, true, 36.0f, 120.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f)
                arcToRelative(68.0f, 68.0f, 0.0f, false, false, 136.0f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 24.0f, 0.0f)
                arcTo(92.14f, 92.14f, 0.0f, false, true, 140.0f, 211.22f)
                close()
            }
        }
        .build()
