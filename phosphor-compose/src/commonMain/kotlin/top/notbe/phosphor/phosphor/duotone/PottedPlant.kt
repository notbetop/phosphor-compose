...
public val DuotoneGroup.PottedPlant: ImageVector
    get() {
        ...
        _pottedPlant = Builder(name = "PottedPlant", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.81f, 6.26f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-41.32f, -2.42f, -74.56f, 10.28f, -88.93f, 34.0f)
                ...
                curveTo(95.53f, 56.0f, 70.6f, 46.4f, 39.73f, 48.22f)
                ...
                curveToRelative(10.46f, -17.26f, 35.23f, -27.0f, 67.0f, -26.57f)
                ...
                curveToRelative(-9.2f, 4.92f, -18.31f, 5.15f, -25.83f, 0.6f)
