    ...
    get() {
        ...
        _slackLogo = Builder(name = "SlackLogo", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(30.0f, 30.0f, 0.0f, true, false, 80.0f, 74.0f)
                lineTo(56.0f, 74.0f)
                arcToRelative(30.0f, 30.0f, 0.0f, false, false, -18.0f, 54.0f)
                arcToRelative(30.0f, 30.0f, 0.0f, true, false, 36.0f, 48.0f)
                verticalLineToRelative(24.0f)
                arcToRelative(30.0f, 30.0f, 0.0f, false, false, 54.0f, 18.0f)
                arcToRelative(30.0f, 30.0f, 0.0f, true, false, 48.0f, -36.0f)
                ...
                lineTo(122.0f, 74.0f)
                lineTo(104.0f, 74.0f)
                arcTo(18.0f, 18.0f, 0.0f, false, true, 86.0f, 56.0f)
                close()
                moveTo(38.0f, 104.0f)
                ...
                lineTo(56.0f, 122.0f)
                arcTo(18.0f, 18.0f, 0.0f, false, true, 38.0f, 104.0f)
                close()
                moveTo(56.0f, 170.0f)
                arcToRelative(18.0f, 18.0f, 0.0f, false, true, 0.0f, -36.0f)
                lineTo(74.0f, 134.0f)
                verticalLineToRelative(18.0f)
                arcTo(18.0f, 18.0f, 0.0f, false, true, 56.0f, 170.0f)
                close()
                ...
                arcTo(18.0f, 18.0f, 0.0f, false, true, 104.0f, 218.0f)
                close()
                moveTo(170.0f, 200.0f)
                arcToRelative(18.0f, 18.0f, 0.0f, false, true, -36.0f, 0.0f)
                lineTo(134.0f, 182.0f)
                horizontalLineToRelative(18.0f)
                arcTo(18.0f, 18.0f, 0.0f, false, true, 170.0f, 200.0f)
                close()
