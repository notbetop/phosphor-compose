    ...
    get() {
        ...
        _heartbeat = Builder(name = "Heartbeat", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 34.92f, 136.0f)
                ...
                lineTo(67.72f, 120.0f)
                horizontalLineTo(23.53f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.83f, -2.81f)
                arcTo(76.93f, 76.93f, 0.0f, false, true, 16.0f, 94.0f)
                arcTo(62.07f, 62.07f, 0.0f, false, true, 78.0f, 32.0f)
                curveToRelative(20.65f, 0.0f, 38.73f, 8.88f, 50.0f, 23.89f)
                curveTo(139.27f, 40.88f, 157.35f, 32.0f, 178.0f, 32.0f)
                arcTo(62.07f, 62.07f, 0.0f, false, true, 240.0f, 94.0f)
                close()
            }
        }
        .build()
