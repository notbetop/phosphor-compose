...
public val DuotoneGroup.NumberFour: ImageVector
    get() {
        if (_numberFour != null) {
            return _numberFour!!
        }
        _numberFour = Builder(name = "NumberFour", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.53f, -10.69f)
                lineToRelative(40.0f, -112.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 15.06f, 5.38f)
                lineTo(83.35f, 144.0f)
                horizontalLineTo(144.0f)
                verticalLineTo(96.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 16.0f, 0.0f)
                verticalLineToRelative(48.0f)
                horizontalLineToRelative(16.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 184.0f, 152.0f)
                close()
            }
        }
        .build()
