    ...
    get() {
        ...
        _musicNotesPlus = Builder(name = "MusicNotesPlus", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 137.0f, 53.88f)
                lineTo(84.0f, 67.12f)
                verticalLineToRelative(39.76f)
                lineToRelative(75.0f, -18.76f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 161.0f, 95.88f)
                close()
                moveTo(76.0f, 204.0f)
                arcToRelative(24.0f, 24.0f, 0.0f, true, false, -24.0f, 24.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 76.0f, 204.0f)
                close()
                ...
                arcToRelative(24.0f, 24.0f, 0.0f, true, false, -24.0f, 24.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 204.0f, 172.0f)
                close()
            }
        }
        .build()
