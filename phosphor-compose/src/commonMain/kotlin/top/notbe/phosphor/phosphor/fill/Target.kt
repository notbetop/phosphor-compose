    ...
    get() {
        ...
        _target = Builder(name = "Target", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(167.6f, 99.71f)
                horizontalLineToRelative(0.0f)
                lineToRelative(-37.71f, 37.71f)
                lineToRelative(-23.95f, 23.95f)
                arcToRelative(40.0f, 40.0f, 0.0f, false, false, 62.0f, -35.67f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, true, 16.0f, -0.9f)
                arcToRelative(56.0f, 56.0f, 0.0f, false, true, -95.5f, 42.79f)
                horizontalLineToRelative(0.0f)
                arcToRelative(56.0f, 56.0f, 0.0f, false, true, 73.13f, -84.43f)
