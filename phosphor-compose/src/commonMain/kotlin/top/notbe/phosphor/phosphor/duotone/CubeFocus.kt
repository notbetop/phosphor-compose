...
public val DuotoneGroup.CubeFocus: ImageVector
    get() {
        if (_cubeFocus != null) {
            return _cubeFocus!!
        }
        _cubeFocus = Builder(name = "CubeFocus", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(184.0f, 98.57f)
                verticalLineToRelative(58.86f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, -2.43f, 4.32f)
                lineTo(130.24f, 191.4f)
                arcToRelative(4.48f, 4.48f, 0.0f, false, true, -4.48f, 0.0f)
                lineTo(74.43f, 161.75f)
                arcTo(5.0f, 5.0f, 0.0f, false, true, 72.0f, 157.43f)
                verticalLineTo(98.57f)
                arcToRelative(5.0f, 5.0f, 0.0f, false, true, 2.43f, -4.32f)
                lineTo(125.76f, 64.6f)
                arcToRelative(4.48f, 4.48f, 0.0f, false, true, 4.48f, 0.0f)
                lineToRelative(51.33f, 29.65f)
                arcTo(5.0f, 5.0f, 0.0f, false, true, 184.0f, 98.57f)
                close()
            }
