...
public val DuotoneGroup.Plugs: ImageVector
    get() {
        if (_plugs != null) {
            return _plugs!!
        }
        _plugs = Builder(name = "Plugs", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(47.0f, 186.91f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 47.0f, 153.0f)
                close()
                moveTo(209.0f, 69.09f)
                lineTo(186.91f, 47.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 153.0f, 47.0f)
                lineTo(124.0f, 76.0f)
                lineToRelative(56.0f, 56.0f)
                lineToRelative(29.0f, -29.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 209.0f, 69.09f)
                close()
            }
