    ...
    get() {
        ...
        _wine = Builder(name = "Wine", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(203.41f, 96.23f)
                lineTo(181.64f, 22.3f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -5.75f, -4.3f)
                lineTo(80.11f, 18.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -5.75f, 4.3f)
                lineTo(52.59f, 96.23f)
                arcToRelative(61.48f, 61.48f, 0.0f, false, false, 16.87f, 62.65f)
                arcTo(85.35f, 85.35f, 0.0f, false, false, 122.0f, 181.77f)
                ...
                arcTo(61.48f, 61.48f, 0.0f, false, false, 203.41f, 96.23f)
                close()
                moveTo(84.6f, 30.0f)
                ...
                curveTo(104.1f, 81.17f, 83.48f, 80.34f, 68.83f, 83.52f)
                close()
                moveTo(178.35f, 150.11f)
                arcToRelative(73.67f, 73.67f, 0.0f, false, true, -100.7f, 0.0f)
                arcTo(49.53f, 49.53f, 0.0f, false, true, 64.09f, 99.63f)
                ...
                arcTo(65.56f, 65.56f, 0.0f, false, false, 194.0f, 114.62f)
                arcTo(49.22f, 49.22f, 0.0f, false, true, 178.35f, 150.11f)
                close()
            }
        }
        .build()
