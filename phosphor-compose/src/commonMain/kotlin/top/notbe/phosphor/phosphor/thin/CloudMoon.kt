    ...
    get() {
        ...
        _cloudMoon = Builder(name = "CloudMoon", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(164.0f, 76.0f)
                arcTo(72.0f, 72.0f, 0.0f, false, false, 148.0f, 77.81f)
                arcTo(68.0f, 68.0f, 0.0f, false, false, 95.27f, 13.72f)
                ...
                arcTo(60.21f, 60.21f, 0.0f, false, true, 23.22f, 99.44f)
                close()
