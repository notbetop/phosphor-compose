    ...
    get() {
        ...
        _note = Builder(name = "Note", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(224.0f, 48.0f)
                lineTo(224.0f, 156.69f)
                arcTo(15.86f, 15.86f, 0.0f, false, true, 219.31f, 168.0f)
                lineTo(168.0f, 219.31f)
                arcTo(15.86f, 15.86f, 0.0f, false, true, 156.69f, 224.0f)
                lineTo(48.0f, 224.0f)
