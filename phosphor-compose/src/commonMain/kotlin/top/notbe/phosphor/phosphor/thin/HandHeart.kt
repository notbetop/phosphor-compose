...
public val ThinGroup.HandHeart: ImageVector
    get() {
        if (_handHeart != null) {
            return _handHeart!!
        }
        _handHeart = Builder(name = "HandHeart", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-11.95f, 2.75f)
                curveTo(223.26f, 121.88f, 236.0f, 100.58f, 236.0f, 80.0f)
                curveToRelative(0.0f, -24.26f, -19.5f, -44.0f, -43.46f, -44.0f)
                arcTo(43.41f, 43.41f, 0.0f, false, false, 156.0f, 55.44f)
                arcTo(43.41f, 43.41f, 0.0f, false, false, 119.46f, 36.0f)
                curveTo(95.5f, 36.0f, 76.0f, 55.74f, 76.0f, 80.0f)
                curveToRelative(0.0f, 11.85f, 4.11f, 23.44f, 12.81f, 36.0f)
                arcToRelative(27.8f, 27.8f, 0.0f, false, false, -18.67f, 8.17f)
                ...
                close()
                moveTo(119.46f, 44.0f)
                arcTo(35.15f, 35.15f, 0.0f, false, true, 152.3f, 65.52f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 7.4f, 0.0f)
                arcTo(35.15f, 35.15f, 0.0f, false, true, 192.54f, 44.0f)
                curveTo(211.76f, 44.0f, 228.0f, 60.49f, 228.0f, 80.0f)
                curveToRelative(0.0f, 21.27f, -16.13f, 44.0f, -47.94f, 67.61f)
                lineTo(160.75f, 152.0f)
                arcTo(23.76f, 23.76f, 0.0f, false, false, 164.0f, 140.0f)
                arcToRelative(24.0f, 24.0f, 0.0f, false, false, -24.0f, -24.0f)
                lineTo(98.69f, 116.0f)
                curveTo(88.69f, 103.0f, 84.0f, 91.5f, 84.0f, 80.0f)
                curveTo(84.0f, 60.49f, 100.24f, 44.0f, 119.46f, 44.0f)
                close()
                moveTo(12.0f, 200.0f)
                lineTo(12.0f, 160.0f)
