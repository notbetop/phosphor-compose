...
public val RegularGroup.DotsSix: ImageVector
    get() {
        if (_dotsSix != null) {
            return _dotsSix!!
        }
        _dotsSix = Builder(name = "DotsSix", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(72.0f, 92.0f)
                arcTo(12.0f, 12.0f, 0.0f, true, true, 60.0f, 80.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 72.0f, 92.0f)
                close()
                moveTo(128.0f, 80.0f)
                ...
                moveTo(60.0f, 152.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, false, 12.0f, 12.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 60.0f, 152.0f)
                close()
