    ...
    get() {
        ...
        _exam = Builder(name = "Exam", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(212.0f, 60.0f)
                close()
                moveTo(63.19f, 171.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 79.0f, 164.81f)
                lineTo(81.1f, 160.0f)
                horizontalLineToRelative(29.8f)
                lineToRelative(2.11f, 4.81f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 22.0f, -9.62f)
                lineToRelative(-28.0f, -64.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -22.0f, 0.0f)
                lineToRelative(-28.0f, 64.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 63.19f, 171.0f)
                close()
                moveTo(100.4f, 136.0f)
                lineTo(91.6f, 136.0f)
                lineTo(96.0f, 125.94f)
                close()
                ...
                verticalLineToRelative(-8.0f)
                horizontalLineToRelative(-8.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 136.0f, 128.0f)
                close()
            }
        }
        .build()
