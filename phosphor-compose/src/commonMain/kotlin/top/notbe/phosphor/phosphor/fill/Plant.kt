    ...
    get() {
        ...
        _plant = Builder(name = "Plant", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(81.38f, 164.69f)
                arcTo(52.5f, 52.5f, 0.0f, false, true, 63.44f, 168.0f)
                arcToRelative(45.82f, 45.82f, 0.0f, false, true, -23.92f, -6.67f)
                curveTo(17.73f, 148.09f, 6.0f, 117.62f, 8.27f, 79.79f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.52f, -7.52f)
                curveToRelative(37.83f, -2.23f, 68.3f, 9.46f, 81.5f, 31.25f)
                arcTo(46.0f, 46.0f, 0.0f, false, true, 103.74f, 132.0f)
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.52f, 7.52f)
                curveTo(250.67f, 91.65f, 234.89f, 133.21f, 205.41f, 151.07f)
                close()
            }
        }
        .build()
