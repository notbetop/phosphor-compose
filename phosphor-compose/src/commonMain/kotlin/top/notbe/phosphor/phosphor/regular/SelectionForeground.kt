...
public val RegularGroup.SelectionForeground: ImageVector
    get() {
        ...
        _selectionForeground = Builder(name = "SelectionForeground", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 64.0f, 216.0f)
                close()
                ...
                lineTo(80.0f, 88.0f)
                arcToRelative(4.44f, 4.44f, 0.0f, false, false, 0.0f, 0.55f)
