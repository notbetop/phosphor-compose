    ...
    get() {
        ...
        _handSwipeLeft = Builder(name = "HandSwipeLeft", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, true, 252.0f, 56.0f)
                close()
                moveTo(180.0f, 116.0f)
                arcToRelative(31.86f, 31.86f, 0.0f, false, false, -11.22f, 2.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 132.0f, 101.0f)
                lineTo(132.0f, 76.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, false, -64.0f, 0.0f)
                verticalLineToRelative(66.83f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 16.28f, 180.0f)
                lineToRelative(0.12f, 0.2f)
                lineToRelative(25.31f, 42.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 62.27f, 209.8f)
                lineTo(37.0f, 167.92f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 50.92f, 160.0f)
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, false, 180.0f, 116.0f)
                close()
            }
        }
        .build()
