    ...
    get() {
        ...
        _flashlight = Builder(name = "Flashlight", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, 2.8f, 8.4f)
                lineToRelative(20.8f, 27.73f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 0.4f, 1.21f)
                verticalLineTo(224.0f)
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, 14.0f)
                horizontalLineToRelative(64.0f)
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, -14.0f)
                verticalLineTo(114.67f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 0.4f, -1.2f)
                ...
                arcTo(2.0f, 2.0f, 0.0f, false, true, 185.6f, 78.53f)
                close()
