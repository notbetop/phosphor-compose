    ...
    get() {
        ...
        _devToLogo = Builder(name = "DevToLogo", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, false, 56.0f, 168.0f)
                close()
                moveTo(68.0f, 112.69f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 76.0f, 124.0f)
                verticalLineToRelative(8.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -8.0f, 11.31f)
                close()
            }
        }
        .build()
