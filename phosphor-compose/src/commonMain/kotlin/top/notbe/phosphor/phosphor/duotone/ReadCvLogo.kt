...
public val DuotoneGroup.ReadCvLogo: ImageVector
    get() {
        if (_readCvLogo != null) {
            return _readCvLogo!!
        }
        _readCvLogo = Builder(name = "ReadCvLogo", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(215.88f, 56.39f)
                lineToRelative(-29.75f, 169.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -9.27f, 6.49f)
                lineToRelative(-130.25f, -23.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.49f, -9.26f)
                lineToRelative(29.75f, -169.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 9.27f, -6.49f)
                lineToRelative(130.25f, 23.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 215.88f, 56.39f)
                close()
            }
