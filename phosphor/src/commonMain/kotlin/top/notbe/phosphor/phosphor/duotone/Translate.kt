    ...
    get() {
        ...
        _translate = Builder(name = "Translate", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(88.0f, 127.56f)
                horizontalLineToRelative(0.0f)
                arcTo(95.78f, 95.78f, 0.0f, false, false, 120.0f, 56.0f)
                horizontalLineTo(56.0f)
                arcTo(95.78f, 95.78f, 0.0f, false, false, 88.0f, 127.56f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(88.0f, 88.0f, 0.0f, false, true, 100.0f, 126.93f)
                arcTo(103.65f, 103.65f, 0.0f, false, false, 127.69f, 64.0f)
                ...
                close()
                moveTo(148.94f, 176.0f)
                lineTo(176.0f, 121.89f)
                lineTo(203.05f, 176.0f)
                close()
            }
        }
        .build()
