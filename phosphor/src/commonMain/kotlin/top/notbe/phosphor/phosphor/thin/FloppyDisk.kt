    ...
    get() {
        ...
        _floppyDisk = Builder(name = "FloppyDisk", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(216.49f, 82.83f)
                lineTo(173.17f, 39.51f)
                arcTo(11.93f, 11.93f, 0.0f, false, false, 164.69f, 36.0f)
                lineTo(48.0f, 36.0f)
                ...
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 12.0f, -12.0f)
                lineTo(220.0f, 91.31f)
                arcTo(11.93f, 11.93f, 0.0f, false, false, 216.49f, 82.83f)
                close()
                ...
                lineTo(44.0f, 48.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, -4.0f)
                lineTo(164.69f, 44.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 2.82f, 1.17f)
                lineToRelative(43.32f, 43.32f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 212.0f, 91.31f)
                close()
                moveTo(156.0f, 72.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, 4.0f)
                lineTo(96.0f, 76.0f)
