...
public val DuotoneGroup.Baseball: ImageVector
    get() {
        if (_baseball != null) {
            return _baseball!!
        }
        _baseball = Builder(name = "Baseball", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(95.74f, 95.74f, 0.0f, false, true, 89.33f, 128.0f)
                arcToRelative(95.74f, 95.74f, 0.0f, false, true, -28.67f, 68.42f)
                arcToRelative(96.0f, 96.0f, 0.0f, false, true, 0.0f, -136.84f)
                close()
                moveTo(195.34f, 59.58f)
                arcToRelative(96.0f, 96.0f, 0.0f, false, false, 0.0f, 136.84f)
                arcToRelative(96.0f, 96.0f, 0.0f, false, false, 0.0f, -136.84f)
                close()
            }
