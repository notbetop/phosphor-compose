    ...
    get() {
        ...
        _virtualReality = Builder(name = "VirtualReality", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(72.0f, 72.0f, 0.0f, false, true, 8.0f, 128.0f)
                horizontalLineTo(8.0f)
                arcTo(72.0f, 72.0f, 0.0f, false, true, 80.0f, 56.0f)
                horizontalLineToRelative(96.0f)
                arcTo(72.0f, 72.0f, 0.0f, false, true, 248.0f, 128.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(123.41f, 99.0f)
                lineToRelative(-26.0f, 64.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -14.82f, 0.0f)
                lineToRelative(-26.0f, -64.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, true, 14.82f, -6.0f)
                lineTo(90.0f, 138.74f)
                lineTo(108.59f, 93.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, true, 14.82f, 6.0f)
                close()
