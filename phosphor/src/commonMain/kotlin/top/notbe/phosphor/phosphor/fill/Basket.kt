...
public val FillGroup.Basket: ImageVector
    get() {
        if (_basket != null) {
            return _basket!!
        }
        _basket = Builder(name = "Basket", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(68.37f, 80.0f)
                lineTo(32.0f, 80.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 16.14f, 98.11f)
                lineTo(30.0f, 202.12f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 45.87f, 216.0f)
                lineTo(210.13f, 216.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 226.0f, 202.12f)
                lineToRelative(13.87f, -104.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 236.0f, 85.46f)
                close()
                moveTo(81.6f, 184.0f)
                arcToRelative(7.44f, 7.44f, 0.0f, false, true, -0.81f, 0.0f)
