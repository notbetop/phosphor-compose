    ...
    get() {
        ...
        _googlePodcastsLogo = Builder(name = "GooglePodcastsLogo", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f)
                lineTo(84.0f, 64.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 80.0f, 60.0f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 176.0f, 132.0f)
                close()
                moveTo(32.0f, 108.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.0f, 4.0f)
                verticalLineToRelative(32.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f)
                lineTo(36.0f, 112.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 32.0f, 108.0f)
                close()
                moveTo(80.0f, 156.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -4.0f, 4.0f)
                verticalLineToRelative(32.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f)
                lineTo(84.0f, 160.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 80.0f, 156.0f)
                close()
