    ...
    get() {
        ...
        _cloudMoon = Builder(name = "CloudMoon", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, false, 86.68f, 20.31f)
                arcTo(52.05f, 52.05f, 0.0f, false, true, 24.3f, 82.68f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 9.93f, 97.07f)
                ...
                arcTo(76.11f, 76.11f, 0.0f, false, false, 111.89f, 36.0f)
                close()
