...
public val LightGroup.Tent: ImageVector
    get() {
        if (_tent != null) {
            return _tent!!
        }
        _tent = Builder(name = "Tent", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(66.0f, 84.27f)
                lineTo(66.0f, 194.0f)
                lineTo(17.23f, 194.0f)
                close()
                moveTo(78.0f, 194.0f)
                lineTo(78.0f, 84.27f)
                lineTo(126.77f, 194.0f)
                close()
                moveTo(139.9f, 194.0f)
                lineTo(81.23f, 62.0f)
                lineTo(180.1f, 62.0f)
