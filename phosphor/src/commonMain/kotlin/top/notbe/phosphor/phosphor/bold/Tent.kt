...
public val BoldGroup.Tent: ImageVector
    get() {
        if (_tent != null) {
            return _tent!!
        }
        _tent = Builder(name = "Tent", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(255.0f, 195.13f)
                lineToRelative(-64.0f, -144.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 180.0f, 44.0f)
                lineTo(76.0f, 44.0f)
                ...
                close()
                moveTo(64.0f, 112.55f)
                lineTo(64.0f, 188.0f)
                lineTo(30.46f, 188.0f)
                close()
                moveTo(88.0f, 188.0f)
                lineTo(88.0f, 112.55f)
                lineTo(121.54f, 188.0f)
                close()
                moveTo(147.8f, 188.0f)
                lineTo(94.47f, 68.0f)
                lineTo(172.2f, 68.0f)
