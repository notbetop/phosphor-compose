...
public val ThinGroup.FileMagnifyingGlass: ImageVector
    get() {
        if (_fileMagnifyingGlass != null) {
            return _fileMagnifyingGlass!!
        }
        _fileMagnifyingGlass = Builder(name = "FileMagnifyingGlass", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(149.26f, 167.61f)
                arcToRelative(32.05f, 32.05f, 0.0f, true, false, -5.65f, 5.65f)
                lineToRelative(13.56f, 13.57f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 5.66f, -5.66f)
                close()
                moveTo(100.0f, 148.0f)
                arcToRelative(24.0f, 24.0f, 0.0f, true, true, 24.0f, 24.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 100.0f, 148.0f)
                close()
            }
        }
        .build()
