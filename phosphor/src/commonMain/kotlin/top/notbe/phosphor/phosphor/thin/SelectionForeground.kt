...
public val ThinGroup.SelectionForeground: ImageVector
    get() {
        ...
        _selectionForeground = Builder(name = "SelectionForeground", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 60.0f, 216.0f)
                close()
                moveTo(112.0f, 212.0f)
                lineTo(96.0f, 212.0f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 40.0f, 164.0f)
                close()
                ...
                verticalLineToRelative(-8.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 168.0f, 196.0f)
                close()
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 4.0f, 4.0f)
                verticalLineToRelative(8.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 168.0f, 108.0f)
                close()
                moveTo(56.0f, 84.0f)
                lineTo(48.0f, 84.0f)
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 3.51f, 3.95f)
                arcToRelative(2.17f, 2.17f, 0.0f, false, false, 0.49f, 0.05f)
