    ...
    get() {
        ...
        _cloudSun = Builder(name = "CloudSun", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(50.0f, 50.0f, 0.0f, false, false, 76.0f, 222.0f)
                horizontalLineToRelative(80.0f)
                arcToRelative(74.0f, 74.0f, 0.0f, false, false, 0.0f, -148.0f)
                close()
                moveTo(46.0f, 104.0f)
                arcToRelative(42.0f, 42.0f, 0.0f, false, true, 77.48f, -22.49f)
                arcTo(74.29f, 74.29f, 0.0f, false, false, 86.2f, 123.0f)
                arcTo(50.36f, 50.36f, 0.0f, false, false, 76.0f, 122.0f)
                arcToRelative(49.65f, 49.65f, 0.0f, false, false, -22.79f, 5.52f)
                arcTo(42.0f, 42.0f, 0.0f, false, true, 46.0f, 104.0f)
                close()
                ...
                arcTo(62.06f, 62.06f, 0.0f, true, true, 156.0f, 210.0f)
                close()
            }
        }
        .build()
