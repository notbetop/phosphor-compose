...
public val FillGroup.Atom: ImageVector
    get() {
        if (_atom != null) {
            return _atom!!
        }
        _atom = Builder(name = "Atom", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(18.47f, 0.0f, 42.48f, -11.17f, 66.0f, -27.88f)
                ...
                arcTo(302.47f, 302.47f, 0.0f, false, false, 141.27f, 70.0f)
                curveTo(172.15f, 49.0f, 196.91f, 43.81f, 204.55f, 51.45f)
                close()
                ...
                curveTo(83.85f, 207.0f, 59.09f, 212.19f, 51.45f, 204.55f)
                close()
