...
public val FillGroup.Percent: ImageVector
    get() {
        if (_percent != null) {
            return _percent!!
        }
        _percent = Builder(name = "Percent", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(92.0f, 96.0f)
                arcTo(12.0f, 12.0f, 0.0f, true, false, 80.0f, 84.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 92.0f, 96.0f)
                close()
                moveTo(224.0f, 48.0f)
                ...
                close()
                moveTo(64.0f, 84.0f)
                arcTo(28.0f, 28.0f, 0.0f, true, false, 92.0f, 56.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 64.0f, 84.0f)
                close()
                moveTo(192.0f, 172.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, true, false, -28.0f, 28.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 192.0f, 172.0f)
                close()
                ...
                lineToRelative(112.0f, -112.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 189.66f, 66.34f)
                close()
            }
        }
        .build()
