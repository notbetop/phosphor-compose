    ...
    get() {
        ...
        _androidLogo = Builder(name = "AndroidLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(37.66f, 50.34f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 26.34f, 61.66f)
                lineTo(51.4f, 86.72f)
                arcTo(113.38f, 113.38f, 0.0f, false, false, 16.0f, 169.13f)
                lineTo(16.0f, 192.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f)
                lineTo(224.0f, 208.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f)
                lineTo(240.0f, 168.0f)
                arcTo(111.25f, 111.25f, 0.0f, false, false, 207.06f, 88.67f)
                close()
                moveTo(92.0f, 168.0f)
