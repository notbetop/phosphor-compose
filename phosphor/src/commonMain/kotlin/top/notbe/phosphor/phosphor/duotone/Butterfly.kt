...
public val DuotoneGroup.Butterfly: ImageVector
    get() {
        if (_butterfly != null) {
            return _butterfly!!
        }
        _butterfly = Builder(name = "Butterfly", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(225.12f, 119.71f)
                curveToRelative(-7.86f, 30.94f, -29.31f, 32.71f, -37.36f, 32.23f)
                horizontalLineToRelative(-1.0f)
                arcTo(36.0f, 36.0f, 0.0f, true, true, 128.0f, 180.0f)
                arcToRelative(36.0f, 36.0f, 0.0f, true, true, -58.72f, -28.06f)
                horizontalLineToRelative(-1.0f)
                curveToRelative(-8.0f, 0.48f, -29.5f, -1.29f, -37.36f, -32.23f)
                curveTo(22.79f, 87.84f, 15.78f, 48.0f, 47.07f, 48.0f)
                reflectiveCurveTo(128.0f, 95.8f, 128.0f, 127.67f)
                curveTo(128.0f, 95.8f, 177.64f, 48.0f, 208.93f, 48.0f)
                reflectiveCurveTo(233.21f, 87.84f, 225.12f, 119.71f)
                close()
            }
