    ...
    get() {
        ...
        _chatCentered = Builder(name = "ChatCentered", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(156.53f, 184.0f)
                arcToRelative(16.07f, 16.07f, 0.0f, false, false, -13.69f, 7.71f)
                lineTo(128.0f, 216.0f)
                lineToRelative(-14.85f, -24.3f)
                arcTo(16.08f, 16.08f, 0.0f, false, false, 99.47f, 184.0f)
                lineTo(40.0f, 184.0f)
                lineTo(40.0f, 56.0f)
                lineTo(216.0f, 56.0f)
                close()
