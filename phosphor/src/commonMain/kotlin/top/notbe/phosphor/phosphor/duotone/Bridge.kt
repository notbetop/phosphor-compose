...
public val DuotoneGroup.Bridge: ImageVector
    get() {
        if (_bridge != null) {
            return _bridge!!
        }
        _bridge = Builder(name = "Bridge", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                verticalLineTo(115.35f)
                arcTo(64.0f, 64.0f, 0.0f, false, false, 64.0f, 56.0f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, false, 128.0f, 0.0f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, false, 40.0f, 59.35f)
                close()
            }
