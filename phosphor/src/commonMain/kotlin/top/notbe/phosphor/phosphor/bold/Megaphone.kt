    ...
    get() {
        ...
        _megaphone = Builder(name = "Megaphone", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(192.92f, 192.92f, 0.0f, false, true, 136.0f, 174.47f)
                ...
                arcTo(20.0f, 20.0f, 0.0f, false, false, 190.37f, 213.0f)
                lineToRelative(11.09f, -41.82f)
                arcTo(52.07f, 52.07f, 0.0f, false, false, 244.0f, 120.0f)
                close()
                moveTo(44.0f, 191.63f)
                verticalLineTo(48.4f)
                curveToRelative(36.17f, 28.07f, 72.17f, 38.1f, 92.0f, 41.66f)
                verticalLineTo(150.0f)
                curveTo(116.17f, 153.52f, 80.17f, 163.55f, 44.0f, 191.63f)
                close()
                moveTo(168.39f, 202.2f)
                lineTo(160.0f, 198.1f)
