    ...
    get() {
        ...
        _gameController = Builder(name = "GameController", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.86f, 207.57f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, true, -24.66f, -7.77f)
                lineTo(150.09f, 152.0f)
                horizontalLineTo(172.0f)
                arcToRelative(51.94f, 51.94f, 0.0f, false, false, 51.2f, -61.0f)
                horizontalLineToRelative(0.0f)
                lineToRelative(16.36f, 84.17f)
                arcTo(28.0f, 28.0f, 0.0f, false, true, 216.86f, 207.57f)
                close()
            }
