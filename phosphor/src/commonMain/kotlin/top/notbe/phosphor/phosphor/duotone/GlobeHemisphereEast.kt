...
public val DuotoneGroup.GlobeHemisphereEast: ImageVector
    get() {
        ...
        _globeHemisphereEast = Builder(name = "GlobeHemisphereEast", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(215.0f, 168.71f)
                arcToRelative(96.42f, 96.42f, 0.0f, false, true, -30.54f, 37.0f)
                lineToRelative(-9.36f, -9.37f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -3.63f, -2.09f)
                lineTo(150.0f, 188.59f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.88f, -8.9f)
                lineToRelative(2.38f, -16.2f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 4.84f, -6.22f)
                lineToRelative(30.46f, -12.66f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.47f, 1.49f)
                close()
                moveTo(159.89f, 105.0f)
                lineTo(182.06f, 79.2f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 184.0f, 74.0f)
                verticalLineTo(50.0f)
                arcTo(96.0f, 96.0f, 0.0f, false, false, 50.49f, 184.65f)
                lineToRelative(9.92f, -6.52f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 64.0f, 171.49f)
                lineToRelative(0.21f, -36.23f)
                arcToRelative(8.06f, 8.06f, 0.0f, false, true, 1.35f, -4.41f)
                lineToRelative(20.94f, -31.3f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.34f, -2.0f)
                lineToRelative(19.81f, 13.0f)
                arcToRelative(8.06f, 8.06f, 0.0f, false, false, 5.77f, 1.45f)
                lineToRelative(31.46f, -4.26f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 159.89f, 105.0f)
                close()
            }
