...
public val DuotoneGroup.Backpack: ImageVector
    get() {
        if (_backpack != null) {
            return _backpack!!
        }
        _backpack = Builder(name = "Backpack", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(48.0f, 48.0f, 0.0f, false, true, 96.0f, 48.0f)
                horizontalLineToRelative(64.0f)
                arcTo(48.0f, 48.0f, 0.0f, false, true, 208.0f, 96.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(168.0f, 40.58f)
                lineTo(168.0f, 32.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 144.0f, 8.0f)
                lineTo(112.0f, 8.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 88.0f, 32.0f)
                verticalLineToRelative(8.58f)
                arcTo(56.09f, 56.09f, 0.0f, false, false, 40.0f, 96.0f)
                lineTo(40.0f, 216.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, 16.0f)
                lineTo(200.0f, 232.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 16.0f, -16.0f)
                lineTo(216.0f, 96.0f)
                arcTo(56.09f, 56.09f, 0.0f, false, false, 168.0f, 40.58f)
                close()
                moveTo(112.0f, 24.0f)
