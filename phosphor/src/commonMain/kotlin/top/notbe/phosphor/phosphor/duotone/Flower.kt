...
public val DuotoneGroup.Flower: ImageVector
    get() {
        if (_flower != null) {
            return _flower!!
        }
        _flower = Builder(name = "Flower", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, -32.0f, -55.42f)
                curveToRelative(-8.87f, 5.12f, -18.61f, 17.48f, -26.87f, 30.0f)
                curveTo(154.17f, 80.87f, 160.0f, 66.25f, 160.0f, 56.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, false, -64.0f, 0.0f)
                curveToRelative(0.0f, 10.25f, 5.83f, 24.87f, 12.52f, 38.26f)
                curveToRelative(-8.26f, -12.49f, -18.0f, -24.85f, -26.87f, -30.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, -32.0f, 55.42f)
                curveToRelative(8.87f, 5.13f, 24.46f, 7.38f, 39.4f, 8.29f)
                curveToRelative(-14.94f, 0.91f, -30.53f, 3.16f, -39.4f, 8.29f)
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, 32.0f, 55.42f)
                curveToRelative(8.87f, -5.12f, 18.61f, -17.48f, 26.87f, -30.0f)
                curveTo(101.83f, 175.13f, 96.0f, 189.75f, 96.0f, 200.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, false, 64.0f, 0.0f)
                curveToRelative(0.0f, -10.25f, -5.83f, -24.87f, -12.52f, -38.26f)
                curveToRelative(8.26f, 12.49f, 18.0f, 24.85f, 26.87f, 30.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, 32.0f, -55.42f)
                close()
                moveTo(155.71f, 144.0f)
                arcTo(32.0f, 32.0f, 0.0f, true, true, 160.0f, 128.0f)
                arcTo(31.74f, 31.74f, 0.0f, false, true, 155.71f, 144.0f)
                close()
            }
