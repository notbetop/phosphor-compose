    ...
    get() {
        ...
        _cloudFog = Builder(name = "CloudFog", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(76.0f, 164.0f)
                arcTo(52.0f, 52.0f, 0.0f, true, true, 85.0f, 60.78f)
                arcTo(76.0f, 76.0f, 0.0f, false, true, 232.0f, 88.0f)
                close()
                moveTo(208.0f, 88.0f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, false, -104.0f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f)
                curveToRelative(0.0f, -1.24f, 0.0f, -2.48f, 0.09f, -3.71f)
                arcTo(29.28f, 29.28f, 0.0f, false, false, 76.0f, 84.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, false, 0.0f, 56.0f)
                horizontalLineToRelative(80.0f)
                arcTo(52.06f, 52.06f, 0.0f, false, false, 208.0f, 88.0f)
                close()
            }
        }
        .build()
