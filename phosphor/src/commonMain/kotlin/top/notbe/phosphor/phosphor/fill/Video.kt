    ...
    get() {
        ...
        _video = Builder(name = "Video", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -3.71f, -6.75f)
                lineToRelative(-44.0f, -28.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 104.0f, 84.0f)
                verticalLineToRelative(56.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 12.29f, 6.75f)
                lineToRelative(44.0f, -28.0f)
