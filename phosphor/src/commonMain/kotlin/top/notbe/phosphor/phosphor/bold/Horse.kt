    ...
    get() {
        ...
        _horse = Builder(name = "Horse", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(81.13f, 81.13f, 0.0f, false, false, 16.2f, 11.26f)
                lineToRelative(21.54f, -29.62f)
                curveToRelative(-20.4f, -7.0f, -41.91f, -3.33f, -54.44f, -1.21f)
                arcToRelative(35.8f, 35.8f, 0.0f, false, true, -35.25f, -14.43f)
                curveToRelative(-0.15f, -0.21f, -0.3f, -0.43f, -0.44f, -0.65f)
                lineToRelative(-13.78f, -22.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 3.88f, -16.58f)
                lineTo(108.0f, 57.29f)
                lineTo(108.0f, 32.0f)
                ...
                lineTo(132.0f, 64.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -5.71f, 10.22f)
                lineTo(32.58f, 131.88f)
                lineToRelative(7.14f, 11.41f)
