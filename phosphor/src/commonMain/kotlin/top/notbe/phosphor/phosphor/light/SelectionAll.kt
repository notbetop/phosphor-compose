...
public val LightGroup.SelectionAll: ImageVector
    get() {
        ...
        _selectionAll = Builder(name = "SelectionAll", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(34.0f, 72.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, false, 40.0f, 78.0f)
                close()
                moveTo(176.0f, 182.0f)
                lineTo(80.0f, 182.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -6.0f, -6.0f)
                lineTo(74.0f, 80.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.0f, -6.0f)
                ...
                arcTo(6.0f, 6.0f, 0.0f, false, true, 176.0f, 182.0f)
                close()
                moveTo(170.0f, 86.0f)
                lineTo(86.0f, 86.0f)
