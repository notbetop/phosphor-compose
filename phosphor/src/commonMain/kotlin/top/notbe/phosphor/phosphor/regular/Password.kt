    ...
    get() {
        ...
        _password = Builder(name = "Password", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-12.34f, -17.0f)
                lineToRelative(20.0f, -6.49f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 132.0f, 110.5f)
                close()
                moveTo(238.0f, 115.64f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 228.0f, 110.5f)
                ...
                lineToRelative(-12.34f, -17.0f)
                lineToRelative(20.0f, -6.49f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 238.0f, 115.64f)
                close()
            }
        }
        .build()
