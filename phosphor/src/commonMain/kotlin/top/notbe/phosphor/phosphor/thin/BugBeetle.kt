    ...
    get() {
        ...
        _bugBeetle = Builder(name = "BugBeetle", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(60.13f, 100.0f)
                arcTo(68.08f, 68.08f, 0.0f, false, true, 128.0f, 36.0f)
                close()
                moveTo(132.0f, 219.87f)
                lineTo(132.0f, 136.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -8.0f, 0.0f)
                verticalLineToRelative(83.87f)
                arcTo(68.08f, 68.08f, 0.0f, false, true, 60.0f, 152.0f)
                lineTo(60.0f, 108.0f)
                lineTo(196.0f, 108.0f)
                verticalLineToRelative(44.0f)
                arcTo(68.08f, 68.08f, 0.0f, false, true, 132.0f, 219.87f)
                close()
            }
        }
        .build()
