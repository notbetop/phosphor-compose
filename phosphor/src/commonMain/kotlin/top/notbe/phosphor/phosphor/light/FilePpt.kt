    ...
    get() {
        ...
        _filePpt = Builder(name = "FilePpt", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(158.0f, 172.0f)
                arcToRelative(26.0f, 26.0f, 0.0f, false, true, -26.0f, 26.0f)
                lineTo(122.0f, 198.0f)
                verticalLineToRelative(10.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f)
                lineTo(110.0f, 152.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 6.0f, -6.0f)
                horizontalLineToRelative(16.0f)
                arcTo(26.0f, 26.0f, 0.0f, false, true, 158.0f, 172.0f)
                close()
                moveTo(146.0f, 172.0f)
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, -14.0f, -14.0f)
                lineTo(122.0f, 158.0f)
                verticalLineToRelative(28.0f)
                horizontalLineToRelative(10.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 146.0f, 172.0f)
                close()
                moveTo(42.0f, 112.0f)
                lineTo(42.0f, 40.0f)
