...
public val DuotoneGroup.CassetteTape: ImageVector
    get() {
        ...
        _cassetteTape = Builder(name = "CassetteTape", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(170.4f, 171.2f)
                lineTo(192.0f, 200.0f)
                lineTo(64.0f, 200.0f)
                lineToRelative(21.6f, -28.8f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 92.0f, 168.0f)
                horizontalLineToRelative(72.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 170.4f, 171.2f)
                close()
                moveTo(176.0f, 88.0f)
