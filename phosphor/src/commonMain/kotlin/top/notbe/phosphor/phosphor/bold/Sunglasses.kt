    ...
    get() {
        ...
        _sunglasses = Builder(name = "Sunglasses", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(211.18f, 170.21f)
                lineTo(189.0f, 148.0f)
                horizontalLineToRelative(23.0f)
                verticalLineToRelative(16.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 211.18f, 170.21f)
                close()
                moveTo(44.0f, 164.0f)
                verticalLineToRelative(-7.0f)
                lineToRelative(30.21f, 30.21f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 44.0f, 164.0f)
                close()
                moveTo(92.0f, 164.0f)
                arcToRelative(24.0f, 24.0f, 0.0f, false, true, -0.82f, 6.21f)
                lineTo(69.0f, 148.0f)
                lineTo(92.0f, 148.0f)
                close()
                ...
                verticalLineToRelative(-7.0f)
                lineToRelative(30.21f, 30.21f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 164.0f, 164.0f)
                close()
            }
        }
        .build()
