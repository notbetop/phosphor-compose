...
public val DuotoneGroup.Tooth: ImageVector
    get() {
        if (_tooth != null) {
            return _tooth!!
        }
        _tooth = Builder(name = "Tooth", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.0f, 79.76f)
                curveToRelative(0.07f, 71.42f, -23.48f, 128.23f, -44.0f, 142.78f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -12.52f, -6.0f)
                curveTo(158.0f, 196.31f, 152.0f, 160.0f, 128.0f, 160.0f)
                reflectiveCurveToRelative(-30.0f, 36.31f, -31.51f, 56.53f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -12.52f, 6.0f)
                curveTo(63.48f, 208.0f, 39.93f, 151.18f, 40.0f, 79.76f)
                arcTo(47.94f, 47.94f, 0.0f, false, true, 88.0f, 32.0f)
                horizontalLineToRelative(80.0f)
                arcTo(47.94f, 47.94f, 0.0f, false, true, 216.0f, 79.76f)
                close()
            }
