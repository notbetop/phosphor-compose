    ...
    get() {
        ...
        _handEye = Builder(name = "HandEye", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(20.0f, 20.0f, 0.0f, false, false, 188.0f, 96.0f)
                close()
                moveTo(128.0f, 200.0f)
                curveToRelative(-32.0f, 0.0f, -48.0f, -32.0f, -48.0f, -32.0f)
                reflectiveCurveToRelative(16.0f, -32.0f, 48.0f, -32.0f)
                reflectiveCurveToRelative(48.0f, 32.0f, 48.0f, 32.0f)
                reflectiveCurveTo(160.0f, 200.0f, 128.0f, 200.0f)
                close()
            }
