...
public val ThinGroup.Van: ImageVector
    get() {
        if (_van != null) {
            return _van!!
        }
        _van = Builder(name = "Van", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(251.0f, 117.4f)
                lineTo(205.47f, 64.3f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 251.0f, 117.4f)
                close()
                moveTo(199.36f, 69.47f)
                lineTo(239.3f, 116.0f)
                lineTo(172.0f, 116.0f)
                lineTo(172.0f, 68.0f)
                horizontalLineToRelative(24.26f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 199.36f, 69.47f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 240.0f, 188.0f)
                close()
            }
        }
        .build()
