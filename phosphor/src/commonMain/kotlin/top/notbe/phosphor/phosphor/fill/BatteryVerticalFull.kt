...
public val FillGroup.BatteryVerticalFull: ImageVector
    get() {
        if (_batteryVerticalFull != null) {
            return _batteryVerticalFull!!
        }
        _batteryVerticalFull = Builder(name = "BatteryVerticalFull", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 8.0f, -8.0f)
                lineTo(168.0f, 72.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 160.0f, 64.0f)
                close()
            }
        }
        .build()
