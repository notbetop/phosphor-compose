    ...
    get() {
        ...
        _heartHalf = Builder(name = "HeartHalf", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(169.47f, 48.79f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -2.94f, -15.73f)
                curveTo(150.42f, 36.08f, 137.0f, 44.18f, 128.0f, 56.0f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 232.55f, 96.0f)
                close()
                moveTo(230.46f, 131.62f)
