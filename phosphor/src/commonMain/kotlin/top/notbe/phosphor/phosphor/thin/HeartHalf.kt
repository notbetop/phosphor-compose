    ...
    get() {
        ...
        _heartHalf = Builder(name = "HeartHalf", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(168.74f, 44.86f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 167.26f, 37.0f)
                curveTo(150.09f, 40.21f, 136.19f, 49.57f, 128.0f, 63.12f)
                curveTo(118.0f, 46.21f, 99.46f, 36.0f, 78.0f, 36.0f)
                ...
                arcTo(343.7f, 343.7f, 0.0f, false, true, 132.0f, 209.09f)
                lineTo(132.0f, 72.85f)
                curveTo(138.24f, 58.26f, 151.58f, 48.07f, 168.74f, 44.86f)
                close()
                moveTo(124.0f, 209.08f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 232.11f, 92.0f)
                close()
                moveTo(226.88f, 129.81f)
