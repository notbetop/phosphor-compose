    ...
    get() {
        ...
        _airTrafficControl = Builder(name = "AirTrafficControl", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(122.0f, 58.0f)
                lineTo(40.0f, 58.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 26.84f, 76.78f)
                lineToRelative(26.19f, 72.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 66.18f, 158.0f)
                lineTo(98.0f, 158.0f)
                ...
                arcTo(14.0f, 14.0f, 0.0f, false, false, 203.0f, 148.78f)
                lineToRelative(26.19f, -72.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 227.47f, 64.0f)
                close()
                moveTo(109.0f, 146.0f)
                lineTo(95.19f, 70.0f)
                horizontalLineToRelative(65.62f)
                lineTo(147.0f, 146.0f)
                close()
                moveTo(64.3f, 144.68f)
                lineToRelative(-26.18f, -72.0f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 0.24f, -1.83f)
                arcTo(1.94f, 1.94f, 0.0f, false, true, 40.0f, 70.0f)
                lineTo(83.0f, 70.0f)
                lineToRelative(13.82f, 76.0f)
                lineTo(66.18f, 146.0f)
                arcTo(2.0f, 2.0f, 0.0f, false, true, 64.3f, 144.68f)
                close()
                moveTo(217.88f, 72.68f)
                lineTo(191.7f, 144.68f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -1.88f, 1.32f)
                lineTo(159.19f, 146.0f)
                lineTo(173.0f, 70.0f)
                horizontalLineToRelative(43.0f)
                arcToRelative(1.94f, 1.94f, 0.0f, false, true, 1.64f, 0.85f)
                arcTo(2.0f, 2.0f, 0.0f, false, true, 217.88f, 72.68f)
                close()
            }
        }
        .build()
