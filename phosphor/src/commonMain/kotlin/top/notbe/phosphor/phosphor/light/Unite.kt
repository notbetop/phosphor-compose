...
public val LightGroup.Unite: ImageVector
    get() {
        if (_unite != null) {
            return _unite!!
        }
        _unite = Builder(name = "Unite", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(134.23f, 149.79f)
                lineTo(106.23f, 121.79f)
                ...
                close()
                moveTo(109.29f, 100.81f)
                lineTo(53.79f, 45.31f)
                arcTo(66.0f, 66.0f, 0.0f, false, true, 73.48f, 34.0f)
                lineToRelative(54.8f, 54.81f)
                arcTo(77.86f, 77.86f, 0.0f, false, false, 109.29f, 100.81f)
                close()
                moveTo(94.0f, 160.0f)
                arcToRelative(65.62f, 65.62f, 0.0f, false, true, 6.0f, -27.49f)
