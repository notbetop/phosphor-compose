    ...
    get() {
        ...
        _eyeglasses = Builder(name = "Eyeglasses", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(44.0f, 44.0f, 0.0f, false, true, -87.81f, 4.0f)
                horizontalLineTo(111.81f)
                arcTo(44.0f, 44.0f, 0.0f, false, true, 24.0f, 164.0f)
                verticalLineTo(72.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, true, 56.0f, 40.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 40.0f, 72.0f)
                verticalLineToRelative(58.08f)
                arcTo(44.0f, 44.0f, 0.0f, false, true, 110.32f, 152.0f)
                horizontalLineToRelative(35.36f)
                arcTo(44.0f, 44.0f, 0.0f, false, true, 216.0f, 130.08f)
                verticalLineTo(72.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, -16.0f, -16.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, -16.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, true, 232.0f, 72.0f)
                close()
            }
        }
        .build()
