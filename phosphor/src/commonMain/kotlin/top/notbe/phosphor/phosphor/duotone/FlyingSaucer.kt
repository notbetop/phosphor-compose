...
public val DuotoneGroup.FlyingSaucer: ImageVector
    get() {
        ...
        _flyingSaucer = Builder(name = "FlyingSaucer", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 26.51f, -50.14f, 48.0f, -112.0f, 48.0f)
                reflectiveCurveTo(16.0f, 138.51f, 16.0f, 112.0f)
                curveToRelative(0.0f, -19.0f, 25.86f, -35.49f, 63.35f, -43.25f)
                horizontalLineToRelative(0.0f)
                arcTo(57.07f, 57.07f, 0.0f, false, false, 72.0f, 96.83f)
                verticalLineTo(99.9f)
                arcToRelative(15.94f, 15.94f, 0.0f, false, false, 12.34f, 15.52f)
                arcTo(195.87f, 195.87f, 0.0f, false, false, 128.0f, 120.0f)
                arcToRelative(195.71f, 195.71f, 0.0f, false, false, 43.64f, -4.58f)
                arcTo(16.0f, 16.0f, 0.0f, false, false, 184.0f, 99.9f)
                verticalLineTo(96.0f)
                arcToRelative(55.7f, 55.7f, 0.0f, false, false, -7.0f, -27.18f)
                horizontalLineToRelative(0.0f)
                curveTo(214.29f, 76.61f, 240.0f, 93.0f, 240.0f, 112.0f)
                close()
            }
