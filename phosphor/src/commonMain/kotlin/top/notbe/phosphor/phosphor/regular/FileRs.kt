...
public val RegularGroup.FileRs: ImageVector
    get() {
        if (_fileRs != null) {
            return _fileRs!!
        }
        _fileRs = Builder(name = "FileRs", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(28.48f, 28.48f, 0.0f, false, false, 5.73f, -0.59f)
                lineTo(77.09f, 212.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 90.91f, 204.0f)
                lineTo(83.8f, 191.78f)
                ...
                curveTo(141.43f, 215.0f, 135.0f, 216.0f, 129.13f, 216.0f)
                ...
                curveToRelative(0.34f, -2.67f, -0.71f, -4.1f, -12.78f, -7.59f)
                ...
                curveTo(141.49f, 174.17f, 158.05f, 179.0f, 155.81f, 196.31f)
                close()
            }
        }
        .build()
