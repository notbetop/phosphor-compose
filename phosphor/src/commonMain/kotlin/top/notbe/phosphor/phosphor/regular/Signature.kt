...
public val RegularGroup.Signature: ImageVector
    get() {
        if (_signature != null) {
            return _signature!!
        }
        _signature = Builder(name = "Signature", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(14.93f, 1.65f, 32.62f, -8.8f, 52.74f, -31.22f)
                ...
                close()
                moveTo(58.79f, 69.26f)
                curveTo(62.78f, 51.78f, 70.48f, 40.0f, 78.0f, 40.0f)
                curveTo(83.25f, 40.0f, 85.0f, 41.86f, 86.0f, 43.67f)
                curveToRelative(3.0f, 5.33f, 6.52f, 24.19f, -21.65f, 86.37f)
                curveTo(56.16f, 118.75f, 53.37f, 93.0f, 58.79f, 69.26f)
                close()
            }
        }
        .build()
