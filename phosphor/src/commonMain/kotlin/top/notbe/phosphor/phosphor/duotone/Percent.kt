    ...
    get() {
        ...
        _percent = Builder(name = "Percent", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, true, 95.8f, 56.2f)
                close()
                moveTo(199.8f, 160.2f)
                arcToRelative(28.0f, 28.0f, 0.0f, true, false, 0.0f, 39.6f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 199.8f, 160.2f)
                close()
            }
