    ...
    get() {
        ...
        _swatches = Builder(name = "Swatches", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(10.0f, 10.0f, 0.0f, false, true, 78.0f, 180.0f)
                close()
                moveTo(230.0f, 156.19f)
                ...
                arcTo(13.94f, 13.94f, 0.0f, false, true, 67.82f, 18.22f)
                ...
                arcTo(15.66f, 15.66f, 0.0f, false, true, 230.0f, 156.19f)
                close()
                moveTo(96.93f, 185.19f)
                lineTo(122.0f, 42.08f)
                ...
                close()
                moveTo(105.18f, 198.36f)
                lineTo(216.71f, 158.0f)
                ...
                arcTo(41.9f, 41.9f, 0.0f, false, true, 105.18f, 198.38f)
                close()
                moveTo(218.0f, 170.27f)
                lineTo(108.35f, 210.0f)
