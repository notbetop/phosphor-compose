    ...
    get() {
        ...
        _cloudSun = Builder(name = "CloudSun", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(51.78f, 51.78f, 0.0f, false, false, 121.0f, 63.83f)
                lineToRelative(11.56f, -16.51f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 126.0f, 42.73f)
                lineTo(114.45f, 59.24f)
                arcTo(52.0f, 52.0f, 0.0f, false, false, 88.0f, 52.0f)
                ...
                arcTo(52.19f, 52.19f, 0.0f, false, false, 47.85f, 71.0f)
                lineTo(31.32f, 59.42f)
                arcTo(4.0f, 4.0f, 0.0f, true, false, 26.73f, 66.0f)
                lineTo(43.26f, 77.54f)
                arcTo(51.63f, 51.63f, 0.0f, false, false, 36.0f, 104.0f)
                ...
                lineToRelative(19.85f, -3.5f)
                arcTo(52.07f, 52.07f, 0.0f, false, false, 46.0f, 134.6f)
                ...
                arcTo(48.28f, 48.28f, 0.0f, false, false, 76.0f, 124.0f)
                arcToRelative(47.76f, 47.76f, 0.0f, false, false, -23.4f, 6.11f)
                arcTo(44.0f, 44.0f, 0.0f, false, true, 44.0f, 104.0f)
                close()
                moveTo(156.0f, 212.0f)
                horizontalLineTo(76.0f)
                arcToRelative(40.0f, 40.0f, 0.0f, true, true, 9.43f, -78.88f)
                arcTo(71.63f, 71.63f, 0.0f, false, false, 84.0f, 143.77f)
                ...
                arcTo(64.06f, 64.06f, 0.0f, true, true, 156.0f, 212.0f)
                close()
            }
        }
        .build()
