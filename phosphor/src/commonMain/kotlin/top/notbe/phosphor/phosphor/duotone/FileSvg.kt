...
public val DuotoneGroup.FileSvg: ImageVector
    get() {
        if (_fileSvg != null) {
            return _fileSvg!!
        }
        _fileSvg = Builder(name = "FileSvg", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.95f, 13.26f)
                arcTo(13.27f, 13.27f, 0.0f, false, false, 192.0f, 160.0f)
                curveToRelative(-8.82f, 0.0f, -16.0f, 9.0f, -16.0f, 20.0f)
                reflectiveCurveToRelative(7.18f, 20.0f, 16.0f, 20.0f)
                arcToRelative(13.38f, 13.38f, 0.0f, false, false, 8.0f, -2.71f)
