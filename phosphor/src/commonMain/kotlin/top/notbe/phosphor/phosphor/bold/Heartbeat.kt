    ...
    get() {
        ...
        _heartbeat = Builder(name = "Heartbeat", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-22.0f, -33.0f)
                lineToRelative(-6.0f, 9.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 71.76f, 140.0f)
                close()
                moveTo(177.91f, 28.0f)
                curveToRelative(-20.12f, 0.0f, -38.0f, 7.93f, -50.07f, 21.56f)
                curveTo(115.74f, 35.93f, 97.89f, 28.0f, 77.76f, 28.0f)
                arcTo(66.0f, 66.0f, 0.0f, false, false, 12.07f, 86.68f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 36.0f, 89.32f)
                arcTo(42.0f, 42.0f, 0.0f, false, true, 77.76f, 52.0f)
                curveToRelative(17.83f, 0.0f, 32.75f, 9.4f, 38.95f, 24.54f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 22.25f, 0.0f)
                curveTo(145.16f, 61.4f, 160.08f, 52.0f, 177.91f, 52.0f)
                arcTo(42.08f, 42.08f, 0.0f, false, true, 220.0f, 94.0f)
                ...
                curveTo(138.0f, 224.14f, 244.0f, 166.34f, 244.0f, 94.0f)
                arcTo(66.12f, 66.12f, 0.0f, false, false, 177.91f, 28.0f)
                close()
            }
        }
        .build()
