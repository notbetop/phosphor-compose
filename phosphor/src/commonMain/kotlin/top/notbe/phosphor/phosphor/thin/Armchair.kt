    ...
    get() {
        ...
        _armchair = Builder(name = "Armchair", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(92.23f)
                arcTo(36.0f, 36.0f, 0.0f, false, false, 172.0f, 128.0f)
                verticalLineToRelative(4.0f)
                horizontalLineTo(84.0f)
                verticalLineToRelative(-4.0f)
                arcTo(36.0f, 36.0f, 0.0f, false, false, 52.0f, 92.23f)
                verticalLineTo(72.0f)
                arcTo(28.0f, 28.0f, 0.0f, false, true, 80.0f, 44.0f)
                close()
