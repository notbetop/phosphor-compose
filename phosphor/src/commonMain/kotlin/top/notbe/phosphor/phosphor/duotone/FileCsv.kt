...
public val DuotoneGroup.FileCsv: ImageVector
    get() {
        if (_fileCsv != null) {
            return _fileCsv!!
        }
        _fileCsv = Builder(name = "FileCsv", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(4.57f, 4.57f, 0.0f, false, true, 2.0f, -3.67f)
                curveToRelative(4.6f, -3.12f, 15.34f, -1.73f, 19.83f, -0.56f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 142.0f, 145.86f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, false, 109.94f, 214.0f)
