    ...
    get() {
        ...
        _airplaneLanding = Builder(name = "AirplaneLanding", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(222.92f, 187.85f)
                lineTo(46.29f, 138.4f)
                arcTo(36.12f, 36.12f, 0.0f, false, true, 20.0f, 103.73f)
                lineTo(20.0f, 48.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 35.79f, 36.63f)
                lineToRelative(5.48f, 1.82f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 2.49f, 2.44f)
                lineTo(55.07f, 72.18f)
                lineTo(92.0f, 82.71f)
                lineTo(92.0f, 48.0f)
                ...
                lineTo(109.0f, 45.47f)
                lineToRelative(-3.75f, -1.25f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 100.0f, 48.0f)
                lineTo(100.0f, 88.0f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 28.0f, 48.0f)
