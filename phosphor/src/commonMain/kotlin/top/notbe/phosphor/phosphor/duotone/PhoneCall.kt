...
public val DuotoneGroup.PhoneCall: ImageVector
    get() {
        if (_phoneCall != null) {
            return _phoneCall!!
        }
        _phoneCall = Builder(name = "PhoneCall", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.73f, -5.94f)
                arcToRelative(70.35f, 70.35f, 0.0f, false, false, -50.33f, -50.33f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 152.27f, 37.93f)
                close()
                moveTo(149.94f, 79.73f)
                curveToRelative(13.79f, 3.68f, 22.65f, 12.54f, 26.33f, 26.33f)
