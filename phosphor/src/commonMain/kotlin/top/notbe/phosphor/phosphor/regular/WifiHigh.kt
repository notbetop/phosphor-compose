...
public val RegularGroup.WifiHigh: ImageVector
    get() {
        if (_wifiHigh != null) {
            return _wifiHigh!!
        }
        _wifiHigh = Builder(name = "WifiHigh", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(172.0f, 172.0f, 0.0f, false, false, 18.92f, 87.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 29.08f, 99.37f)
                arcToRelative(156.0f, 156.0f, 0.0f, false, true, 197.84f, 0.0f)
