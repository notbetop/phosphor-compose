...
public val DuotoneGroup.MediumLogo: ImageVector
    get() {
        if (_mediumLogo != null) {
            return _mediumLogo!!
        }
        _mediumLogo = Builder(name = "MediumLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(56.0f, 56.0f, 0.0f, true, true, 72.0f, 72.0f)
                arcTo(56.0f, 56.0f, 0.0f, false, true, 128.0f, 128.0f)
                close()
                moveTo(184.0f, 72.0f)
                curveToRelative(-13.25f, 0.0f, -24.0f, 25.07f, -24.0f, 56.0f)
                reflectiveCurveToRelative(10.75f, 56.0f, 24.0f, 56.0f)
                reflectiveCurveToRelative(24.0f, -25.07f, 24.0f, -56.0f)
                reflectiveCurveTo(197.25f, 72.0f, 184.0f, 72.0f)
                close()
            }
