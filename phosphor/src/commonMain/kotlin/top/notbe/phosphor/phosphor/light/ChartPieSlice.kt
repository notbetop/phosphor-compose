    ...
    get() {
        ...
        _chartPieSlice = Builder(name = "ChartPieSlice", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(216.57f, 77.45f)
                curveToRelative(-0.08f, -0.16f, -0.16f, -0.32f, -0.25f, -0.47f)
                arcToRelative(3.0f, 3.0f, 0.0f, false, false, -0.27f, -0.42f)
                ...
                arcTo(101.41f, 101.41f, 0.0f, false, false, 216.57f, 77.45f)
                close()
                moveTo(134.0f, 38.2f)
                arcToRelative(90.0f, 90.0f, 0.0f, false, true, 68.76f, 39.74f)
                lineTo(134.0f, 118.0f)
                close()
                moveTo(128.0f, 218.0f)
                arcToRelative(90.48f, 90.48f, 0.0f, false, true, -74.38f, -39.31f)
                lineToRelative(77.31f, -45.0f)
                lineToRelative(0.17f, -0.1f)
                lineToRelative(77.67f, -45.24f)
