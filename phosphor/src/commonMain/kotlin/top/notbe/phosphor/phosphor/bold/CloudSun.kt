    ...
    get() {
        ...
        _cloudSun = Builder(name = "CloudSun", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(111.87f, 49.0f)
                arcTo(59.85f, 59.85f, 0.0f, false, false, 89.61f, 44.0f)
                lineToRelative(-2.3f, -13.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, -23.63f, 4.17f)
                lineToRelative(2.3f, 13.0f)
                arcTo(60.0f, 60.0f, 0.0f, false, false, 46.77f, 60.47f)
                lineTo(35.91f, 52.86f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 22.14f, 72.52f)
                lineTo(33.0f, 80.11f)
                arcTo(59.45f, 59.45f, 0.0f, false, false, 28.0f, 102.36f)
                ...
                arcTo(56.5f, 56.5f, 0.0f, false, false, 76.0f, 116.0f)
                arcToRelative(55.84f, 55.84f, 0.0f, false, false, -20.33f, 3.83f)
                arcTo(36.0f, 36.0f, 0.0f, false, true, 88.0f, 68.0f)
                close()
                ...
                arcTo(56.06f, 56.06f, 0.0f, true, true, 156.0f, 204.0f)
                close()
            }
        }
        .build()
