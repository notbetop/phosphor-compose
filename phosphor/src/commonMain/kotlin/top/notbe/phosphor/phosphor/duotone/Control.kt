...
public val DuotoneGroup.Control: ImageVector
    get() {
        if (_control != null) {
            return _control!!
        }
        _control = Builder(name = "Control", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(205.66f, 114.34f)
                lineToRelative(-72.0f, -72.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 0.0f)
                lineToRelative(-72.0f, 72.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 56.0f, 128.0f)
                horizontalLineTo(200.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.66f, -13.66f)
                close()
                moveTo(75.31f, 112.0f)
                lineTo(128.0f, 59.31f)
                lineTo(180.69f, 112.0f)
                close()
            }
        }
        .build()
