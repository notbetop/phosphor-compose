    ...
    get() {
        ...
        _paintRoller = Builder(name = "PaintRoller", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(228.0f, 151.0f)
                lineTo(130.5f, 178.8f)
                arcTo(20.09f, 20.09f, 0.0f, false, false, 116.0f, 198.0f)
                verticalLineToRelative(34.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, false, 24.0f, 0.0f)
                lineTo(140.0f, 201.05f)
                lineToRelative(97.5f, -27.85f)
                arcTo(20.09f, 20.09f, 0.0f, false, false, 252.0f, 154.0f)
