    ...
    get() {
        ...
        _globe = Builder(name = "Globe", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(128.0f, 40.11f)
                curveToRelative(12.0f, 13.0f, 21.0f, 29.55f, 26.37f, 47.89f)
                lineTo(101.63f, 88.0f)
                curveTo(107.0f, 69.66f, 116.0f, 53.13f, 128.0f, 40.11f)
                close()
                moveTo(96.0f, 128.0f)
                arcToRelative(145.29f, 145.29f, 0.0f, false, true, 2.0f, -24.0f)
                horizontalLineToRelative(60.0f)
                arcToRelative(145.72f, 145.72f, 0.0f, false, true, 0.0f, 48.0f)
                lineTo(98.0f, 152.0f)
                arcTo(145.29f, 145.29f, 0.0f, false, true, 96.0f, 128.0f)
                close()
