    ...
    get() {
        ...
        _textAa = Builder(name = "TextAa", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(9.34f, 0.0f, 17.19f, 5.16f, 19.37f, 12.1f)
                arcTo(47.32f, 47.32f, 0.0f, false, false, 200.0f, 124.0f)
                ...
                curveTo(244.0f, 109.94f, 224.26f, 92.0f, 200.0f, 92.0f)
                close()
