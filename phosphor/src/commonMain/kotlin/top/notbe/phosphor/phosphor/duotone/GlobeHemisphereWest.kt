...
public val DuotoneGroup.GlobeHemisphereWest: ImageVector
    get() {
        ...
        _globeHemisphereWest = Builder(name = "GlobeHemisphereWest", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(96.0f, 96.0f, 0.0f, false, true, -80.41f, 51.41f)
                lineToRelative(3.17f, -16.44f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -2.0f, -6.95f)
                lineToRelative(-19.74f, -20.33f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -1.44f, -8.69f)
                lineToRelative(13.7f, -30.74f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.38f, -4.67f)
                lineToRelative(22.82f, 3.08f)
                arcToRelative(8.11f, 8.11f, 0.0f, false, true, 3.12f, 1.11f)
                close()
                moveTo(116.71f, 95.0f)
                lineTo(129.0f, 88.24f)
                arcToRelative(7.46f, 7.46f, 0.0f, false, false, 1.5f, -1.07f)
                lineToRelative(26.91f, -24.33f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 159.0f, 53.0f)
                lineToRelative(-10.5f, -18.81f)
                arcTo(96.62f, 96.62f, 0.0f, false, false, 128.0f, 32.0f)
                arcTo(95.61f, 95.61f, 0.0f, false, false, 67.78f, 53.23f)
                lineTo(56.0f, 81.08f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 55.88f, 87.0f)
                lineToRelative(11.5f, 30.67f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 5.81f, 5.0f)
                lineToRelative(2.69f, 0.58f)
                lineTo(89.2f, 100.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 6.94f, -4.0f)
                horizontalLineToRelative(16.71f)
                arcTo(7.9f, 7.9f, 0.0f, false, false, 116.71f, 95.0f)
                close()
            }
