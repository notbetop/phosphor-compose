    ...
    get() {
        ...
        _heartHalf = Builder(name = "HeartHalf", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                reflectiveCurveTo(24.0f, 160.0f, 24.0f, 94.0f)
                arcTo(54.0f, 54.0f, 0.0f, false, true, 78.0f, 40.0f)
                curveTo(100.59f, 40.0f, 119.94f, 52.31f, 128.0f, 72.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(93.59f, 185.44f, 32.0f, 141.78f, 32.0f, 94.0f)
                close()
                moveTo(136.0f, 202.0f)
                verticalLineTo(73.65f)
                curveTo(143.14f, 57.79f, 159.09f, 48.0f, 178.0f, 48.0f)
                arcToRelative(46.06f, 46.06f, 0.0f, false, true, 46.0f, 46.0f)
                curveTo(224.0f, 141.71f, 162.42f, 185.41f, 136.0f, 202.0f)
                close()
            }
        }
        .build()
