...
public val DuotoneGroup.EyedropperSample: ImageVector
    get() {
        ...
        _eyedropperSample = Builder(name = "EyedropperSample", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineToRelative(-38.62f, 38.63f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, -32.06f, 8.0f)
                horizontalLineToRelative(0.0f)
                lineToRelative(-20.0f, 8.74f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -8.86f, -1.67f)
                arcToRelative(5.74f, 5.74f, 0.0f, false, true, -1.2f, -6.36f)
                lineToRelative(9.19f, -21.06f)
                horizontalLineToRelative(0.0f)
                arcTo(32.07f, 32.07f, 0.0f, false, true, 52.3f, 160.0f)
                close()
                moveTo(207.23f, 47.51f)
                curveToRelative(-11.07f, -10.49f, -28.65f, -9.83f, -39.44f, 1.0f)
                ...
                lineTo(207.8f, 87.66f)
                arcTo(28.0f, 28.0f, 0.0f, false, false, 207.23f, 47.51f)
                close()
            }
