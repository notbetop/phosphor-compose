...
public val DuotoneGroup.Recycle: ImageVector
    get() {
        if (_recycle != null) {
            return _recycle!!
        }
        _recycle = Builder(name = "Recycle", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, -13.84f, -24.0f)
                lineToRelative(88.0f, -152.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, 27.7f, 0.0f)
                lineToRelative(88.0f, 152.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 216.0f, 208.0f)
                close()
            }
