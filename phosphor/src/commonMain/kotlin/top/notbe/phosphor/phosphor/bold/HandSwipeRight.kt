    ...
    get() {
        ...
        _handSwipeRight = Builder(name = "HandSwipeRight", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, false, 37.0f, 167.92f)
                lineTo(62.27f, 209.8f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -20.56f, 12.39f)
                lineToRelative(-25.31f, -42.0f)
                lineToRelative(-0.12f, -0.2f)
                arcTo(32.0f, 32.0f, 0.0f, false, true, 68.0f, 142.83f)
                verticalLineTo(76.0f)
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, true, 212.0f, 148.0f)
                close()
                moveTo(248.48f, 47.51f)
                ...
                lineTo(199.51f, 79.51f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, false, 17.0f, 17.0f)
                lineToRelative(32.0f, -32.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, false, 248.48f, 47.51f)
                close()
            }
        }
        .build()
