    ...
    get() {
        ...
        _appleLogo = Builder(name = "AppleLogo", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.0f, 73.52f)
                close()
                moveTo(216.0f, 172.78f)
                curveToRelative(-16.79f, -11.53f, -24.0f, -30.87f, -24.0f, -52.78f)
                curveToRelative(0.0f, -18.3f, 11.68f, -34.81f, 24.0f, -46.48f)
                curveTo(204.53f, 62.66f, 185.0f, 56.0f, 168.0f, 56.0f)
                arcToRelative(63.72f, 63.72f, 0.0f, false, false, -40.0f, 14.0f)
                horizontalLineToRelative(0.0f)
                arcTo(63.71f, 63.71f, 0.0f, false, false, 88.88f, 56.0f)
                curveTo(52.0f, 55.5f, 23.06f, 86.3f, 24.0f, 123.19f)
                arcToRelative(119.62f, 119.62f, 0.0f, false, false, 37.65f, 84.12f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 83.6f, 216.0f)
                horizontalLineToRelative(87.7f)
                arcToRelative(31.75f, 31.75f, 0.0f, false, false, 23.26f, -10.0f)
                curveToRelative(15.85f, -17.0f, 21.44f, -33.2f, 21.44f, -33.2f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(55.39f, 55.39f, 0.0f, false, true, 168.0f, 64.0f)
                ...
                arcTo(105.52f, 105.52f, 0.0f, false, true, 188.67f, 200.53f)
                close()
