    ...
    get() {
        ...
        _fastForward = Builder(name = "FastForward", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(239.59f, 116.35f)
                lineTo(151.41f, 60.18f)
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, -14.22f, -0.46f)
                arcTo(13.83f, 13.83f, 0.0f, false, false, 130.0f, 71.84f)
                verticalLineToRelative(41.0f)
                lineTo(47.41f, 60.18f)
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, -14.22f, -0.46f)
                arcTo(13.83f, 13.83f, 0.0f, false, false, 26.0f, 71.84f)
                lineTo(26.0f, 184.16f)
                arcToRelative(13.83f, 13.83f, 0.0f, false, false, 7.19f, 12.12f)
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.22f, -0.46f)
                lineTo(130.0f, 143.21f)
                ...
                close()
                moveTo(129.15f, 129.53f)
                lineTo(41.0f, 185.69f)
                ...
                close()
                moveTo(233.15f, 129.53f)
                lineTo(145.0f, 185.69f)
                arcToRelative(1.9f, 1.9f, 0.0f, false, true, -2.0f, 0.06f)
                arcToRelative(1.73f, 1.73f, 0.0f, false, true, -1.0f, -1.59f)
                lineTo(142.0f, 71.84f)
                arcToRelative(1.73f, 1.73f, 0.0f, false, true, 1.0f, -1.59f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, 1.0f, -0.26f)
                arcToRelative(1.87f, 1.87f, 0.0f, false, true, 1.0f, 0.32f)
                lineToRelative(88.19f, 56.16f)
