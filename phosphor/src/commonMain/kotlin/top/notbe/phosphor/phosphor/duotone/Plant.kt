...
public val DuotoneGroup.Plant: ImageVector
    get() {
        if (_plant != null) {
            return _plant!!
        }
        _plant = Builder(name = "Plant", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(138.54f, 141.46f)
                curveTo(106.62f, 88.25f, 149.18f, 35.05f, 239.63f, 40.37f)
                curveTo(245.0f, 130.82f, 191.75f, 173.39f, 138.54f, 141.46f)
                close()
                moveTo(16.26f, 80.26f)
                curveToRelative(-3.8f, 64.61f, 34.21f, 95.0f, 72.21f, 72.21f)
                curveTo(111.27f, 114.47f, 80.87f, 76.46f, 16.26f, 80.26f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(247.63f, 39.89f)
                ...
                lineTo(98.33f, 151.0f)
                curveToRelative(7.82f, -16.33f, 7.52f, -33.36f, -1.0f, -47.49f)
                curveTo(84.09f, 81.73f, 53.62f, 70.0f, 15.79f, 72.27f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -7.52f, 7.52f)
                curveToRelative(-2.23f, 37.83f, 9.46f, 68.3f, 31.25f, 81.5f)
                arcTo(45.82f, 45.82f, 0.0f, false, false, 63.44f, 168.0f)
                arcTo(54.58f, 54.58f, 0.0f, false, false, 87.0f, 162.33f)
                lineToRelative(25.0f, 25.0f)
                lineTo(112.0f, 216.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 16.0f, 0.0f)
                lineTo(128.0f, 186.51f)
                ...
                curveTo(234.89f, 133.21f, 250.67f, 91.65f, 247.63f, 39.89f)
                close()
                moveTo(86.06f, 138.74f)
                ...
                curveTo(32.47f, 138.31f, 23.79f, 116.32f, 24.0f, 88.0f)
                curveToRelative(28.31f, -0.25f, 50.31f, 8.47f, 59.6f, 23.81f)
                curveTo(88.45f, 119.82f, 89.24f, 129.14f, 86.06f, 138.74f)
                close()
                moveTo(197.12f, 137.38f)
