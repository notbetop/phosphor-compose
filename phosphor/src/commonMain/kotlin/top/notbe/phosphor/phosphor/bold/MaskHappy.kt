    ...
    get() {
        ...
        _maskHappy = Builder(name = "MaskHappy", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(41.8f, 41.8f, 0.0f, false, true, 45.0f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -13.0f, 20.2f)
                arcToRelative(17.81f, 17.81f, 0.0f, false, false, -19.06f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -16.59f, -3.61f)
                close()
                moveTo(92.0f, 132.0f)
                arcToRelative(19.14f, 19.14f, 0.0f, false, false, -9.53f, 2.77f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -13.0f, -20.19f)
                arcToRelative(41.78f, 41.78f, 0.0f, false, true, 45.0f, 0.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -13.0f, 20.19f)
