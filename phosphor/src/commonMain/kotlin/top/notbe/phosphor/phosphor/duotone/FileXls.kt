...
public val DuotoneGroup.FileXls: ImageVector
    get() {
        if (_fileXls != null) {
            return _fileXls!!
        }
        _fileXls = Builder(name = "FileXls", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(20.58f, 20.58f, 0.0f, false, false, -8.95f, 14.94f)
                curveToRelative(-2.0f, 15.89f, 13.65f, 20.42f, 23.0f, 23.12f)
                curveToRelative(12.06f, 3.49f, 13.12f, 4.92f, 12.78f, 7.59f)
                curveToRelative(-0.31f, 2.41f, -1.26f, 3.33f, -2.15f, 3.93f)
                curveToRelative(-4.6f, 3.06f, -15.16f, 1.56f, -19.54f, 0.35f)
