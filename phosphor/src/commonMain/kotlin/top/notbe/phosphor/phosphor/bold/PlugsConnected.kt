    ...
    get() {
        ...
        _plugsConnected = Builder(name = "PlugsConnected", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 0.0f, 17.0f)
                close()
                moveTo(20.62f, 92.21f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 35.8f, 84.62f)
                lineToRelative(12.0f, 4.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, -7.59f, 22.76f)
                lineToRelative(-12.0f, -4.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 20.62f, 92.21f)
                close()
                moveTo(84.62f, 35.8f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, 22.76f, -7.59f)
                lineToRelative(4.0f, 12.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 88.62f, 47.8f)
                close()
                moveTo(235.38f, 163.8f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -15.18f, 7.58f)
                lineToRelative(-12.0f, -4.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 7.59f, -22.76f)
                lineToRelative(12.0f, 4.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 235.38f, 163.8f)
                close()
                moveTo(171.38f, 220.21f)
