...
public val RegularGroup.MicrosoftOutlookLogo: ImageVector
    get() {
        ...
        _microsoftOutlookLogo = Builder(name = "MicrosoftOutlookLogo", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, false, 88.0f, 96.0f)
                close()
                moveTo(88.0f, 144.0f)
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 216.0f, 104.0f)
                close()
                moveTo(112.0f, 48.0f)
