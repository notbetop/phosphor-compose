    ...
    get() {
        ...
        _linuxLogo = Builder(name = "LinuxLogo", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(226.49f, 219.12f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -5.61f, -0.62f)
                curveTo(219.54f, 216.82f, 188.0f, 176.48f, 188.0f, 96.0f)
                ...
                curveTo(29.18f, 213.11f, 60.0f, 173.45f, 60.0f, 96.0f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 226.49f, 219.12f)
                close()
