...
public val LightGroup.EyedropperSample: ImageVector
    get() {
        ...
        _eyedropperSample = Builder(name = "EyedropperSample", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(37.81f, 37.81f, 0.0f, false, false, -9.84f, 36.73f)
                ...
                lineToRelative(9.0f, -9.0f)
                arcToRelative(22.06f, 22.06f, 0.0f, false, false, 0.0f, -31.13f)
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -4.17f, 0.24f)
                ...
                arcTo(25.91f, 25.91f, 0.0f, false, true, 56.0f, 166.0f)
                horizontalLineToRelative(70.78f)
                close()
                moveTo(138.78f, 154.0f)
                lineTo(65.24f, 154.0f)
                lineToRelative(48.83f, -48.84f)
                lineToRelative(36.76f, 36.78f)
                close()
                moveTo(203.55f, 83.41f)
                ...
                curveToRelative(8.57f, -8.58f, 22.51f, -9.0f, 31.07f, -0.85f)
