    ...
    get() {
        ...
        _stamp = Builder(name = "Stamp", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(159.46f, 53.0f)
                lineToRelative(-17.78f, 83.0f)
                horizontalLineTo(114.32f)
                lineTo(96.54f, 53.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 120.0f, 24.0f)
                horizontalLineToRelative(16.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 159.46f, 53.0f)
                close()
            }
