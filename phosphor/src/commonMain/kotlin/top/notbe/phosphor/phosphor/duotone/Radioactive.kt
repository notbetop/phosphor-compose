...
public val DuotoneGroup.Radioactive: ImageVector
    get() {
        ...
        _radioactive = Builder(name = "Radioactive", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(92.0f, 128.0f)
                lineTo(40.0f, 128.0f)
                arcToRelative(8.1f, 8.1f, 0.0f, false, true, -8.0f, -8.86f)
                arcTo(95.94f, 95.94f, 0.0f, false, true, 72.27f, 49.47f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 83.82f, 52.0f)
                lineToRelative(26.0f, 44.94f)
                arcTo(36.0f, 36.0f, 0.0f, false, false, 92.0f, 128.0f)
                close()
                moveTo(146.0f, 159.18f)
                arcToRelative(36.0f, 36.0f, 0.0f, false, true, -36.0f, 0.0f)
                lineTo(84.17f, 203.91f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 3.56f, 11.26f)
                arcToRelative(96.24f, 96.24f, 0.0f, false, false, 80.54f, 0.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 3.56f, -11.26f)
                close()
                moveTo(224.0f, 119.18f)
                arcToRelative(95.94f, 95.94f, 0.0f, false, false, -40.24f, -69.67f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 172.18f, 52.0f)
                lineTo(146.23f, 97.0f)
                arcTo(36.0f, 36.0f, 0.0f, false, true, 164.0f, 126.12f)
                curveToRelative(0.0f, 0.62f, 0.05f, 1.23f, 0.05f, 1.85f)
                lineToRelative(52.0f, 0.0f)
                arcTo(8.1f, 8.1f, 0.0f, false, false, 224.0f, 119.14f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-51.93f, 0.0f)
                arcToRelative(0.19f, 0.19f, 0.0f, false, true, -0.07f, -0.16f)
                arcTo(87.83f, 87.83f, 0.0f, false, true, 76.89f, 56.0f)
