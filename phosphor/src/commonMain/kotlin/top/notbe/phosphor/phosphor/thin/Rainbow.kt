    ...
    get() {
        ...
        _rainbow = Builder(name = "Rainbow", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(84.09f, 84.09f, 0.0f, false, false, 128.0f, 84.0f)
                close()
                moveTo(128.0f, 52.0f)
                arcTo(116.13f, 116.13f, 0.0f, false, false, 12.0f, 168.0f)
                verticalLineToRelative(16.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, 8.0f, 0.0f)
                lineTo(20.0f, 168.0f)
                ...
                arcTo(116.13f, 116.13f, 0.0f, false, false, 128.0f, 52.0f)
                close()
            }
        }
        .build()
