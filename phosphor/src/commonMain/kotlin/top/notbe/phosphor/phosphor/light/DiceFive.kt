...
public val LightGroup.DiceFive: ImageVector
    get() {
        if (_diceFive != null) {
            return _diceFive!!
        }
        _diceFive = Builder(name = "DiceFive", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(102.0f, 92.0f)
                arcTo(10.0f, 10.0f, 0.0f, true, true, 92.0f, 82.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 102.0f, 92.0f)
                close()
                ...
                moveTo(174.0f, 92.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 174.0f, 92.0f)
                close()
                moveTo(102.0f, 164.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 102.0f, 164.0f)
                close()
                moveTo(174.0f, 164.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 174.0f, 164.0f)
                close()
            }
        }
        .build()
