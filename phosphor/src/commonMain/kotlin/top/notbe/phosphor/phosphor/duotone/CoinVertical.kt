...
public val DuotoneGroup.CoinVertical: ImageVector
    get() {
        ...
        _coinVertical = Builder(name = "CoinVertical", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 53.0f, -25.07f, 96.0f, -56.0f, 96.0f)
                reflectiveCurveToRelative(-56.0f, -43.0f, -56.0f, -96.0f)
                reflectiveCurveToRelative(25.07f, -96.0f, 56.0f, -96.0f)
                reflectiveCurveTo(160.0f, 75.0f, 160.0f, 128.0f)
                close()
            }
