    ...
    get() {
        ...
        _funnel = Builder(name = "Funnel", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(148.34f, 128.28f)
                arcTo(15.92f, 15.92f, 0.0f, false, false, 144.0f, 139.17f)
                verticalLineToRelative(55.49f)
                lineTo(112.0f, 216.0f)
                lineTo(112.0f, 139.17f)
                arcToRelative(15.92f, 15.92f, 0.0f, false, false, -4.32f, -10.94f)
                lineTo(40.0f, 56.0f)
                lineTo(216.0f, 56.0f)
                close()
            }
