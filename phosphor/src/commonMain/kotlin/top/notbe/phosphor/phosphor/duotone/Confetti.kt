...
public val DuotoneGroup.Confetti: ImageVector
    get() {
        if (_confetti != null) {
            return _confetti!!
        }
        _confetti = Builder(name = "Confetti", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(58.89f, 154.89f)
                lineToRelative(42.22f, 42.22f)
                lineToRelative(-50.63f, 18.4f)
                arcToRelative(7.79f, 7.79f, 0.0f, false, true, -10.0f, -10.0f)
                close()
                moveTo(197.71f, 150.17f)
                lineTo(105.83f, 58.29f)
                arcTo(7.79f, 7.79f, 0.0f, false, false, 93.0f, 61.14f)
                lineToRelative(-14.9f, 41.0f)
                lineToRelative(75.82f, 75.82f)
                lineToRelative(41.0f, -14.9f)
                arcTo(7.79f, 7.79f, 0.0f, false, false, 197.71f, 150.17f)
                close()
            }
