...
public val LightGroup.AppWindow: ImageVector
    get() {
        if (_appWindow != null) {
            return _appWindow!!
        }
        _appWindow = Builder(name = "AppWindow", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(78.0f, 84.0f)
                arcTo(10.0f, 10.0f, 0.0f, true, true, 68.0f, 74.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 78.0f, 84.0f)
                close()
                moveTo(118.0f, 84.0f)
                arcToRelative(10.0f, 10.0f, 0.0f, true, true, -10.0f, -10.0f)
                arcTo(10.0f, 10.0f, 0.0f, false, true, 118.0f, 84.0f)
                close()
            }
        }
        .build()
