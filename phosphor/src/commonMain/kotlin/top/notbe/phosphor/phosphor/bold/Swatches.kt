    ...
    get() {
        ...
        _swatches = Builder(name = "Swatches", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(234.79f, 149.32f)
                lineTo(215.7f, 97.11f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 190.12f, 85.2f)
                lineToRelative(-61.31f, 22.22f)
                lineTo(139.7f, 45.18f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 123.55f, 22.0f)
                lineTo(68.87f, 12.31f)
                arcTo(19.94f, 19.94f, 0.0f, false, false, 45.76f, 28.55f)
                lineToRelative(-25.0f, 143.13f)
                arcTo(48.0f, 48.0f, 0.0f, false, false, 59.4f, 227.26f)
                arcToRelative(51.19f, 51.19f, 0.0f, false, false, 8.7f, 0.74f)
                lineTo(216.0f, 228.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, 20.0f, -20.0f)
                lineTo(236.0f, 156.19f)
                arcTo(21.74f, 21.74f, 0.0f, false, false, 234.79f, 149.32f)
                close()
                moveTo(91.0f, 184.18f)
                ...
                lineTo(68.71f, 36.66f)
                lineTo(115.37f, 45.0f)
                lineTo(91.0f, 184.18f)
                close()
                moveTo(114.64f, 188.31f)
                lineTo(124.03f, 134.67f)
                lineTo(194.52f, 109.13f)
                lineTo(210.82f, 153.72f)
                lineTo(114.59f, 188.59f)
                curveTo(114.62f, 188.5f, 114.65f, 188.41f, 114.66f, 188.31f)
                close()
                moveTo(212.0f, 204.0f)
                lineTo(142.52f, 204.0f)
                lineTo(212.0f, 178.82f)
                close()
                moveTo(81.22f, 174.07f)
                lineToRelative(-1.4f, 8.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 68.0f, 192.0f)
