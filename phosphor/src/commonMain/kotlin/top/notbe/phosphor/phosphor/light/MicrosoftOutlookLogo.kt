...
public val LightGroup.MicrosoftOutlookLogo: ImageVector
    get() {
        ...
        _microsoftOutlookLogo = Builder(name = "MicrosoftOutlookLogo", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(112.0f, 34.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 98.0f, 48.0f)
                lineTo(98.0f, 66.0f)
                lineTo(40.0f, 66.0f)
                ...
                arcToRelative(14.0f, 14.0f, 0.0f, false, false, 14.0f, -14.0f)
                lineTo(230.0f, 120.0f)
                arcTo(14.0f, 14.0f, 0.0f, false, false, 216.0f, 106.0f)
                close()
