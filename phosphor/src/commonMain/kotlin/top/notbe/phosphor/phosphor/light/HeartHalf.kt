    ...
    get() {
        ...
        _heartHalf = Builder(name = "HeartHalf", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(169.1f, 46.82f)
                arcTo(6.0f, 6.0f, 0.0f, true, false, 166.9f, 35.0f)
                curveTo(150.3f, 38.13f, 136.65f, 46.82f, 128.0f, 59.4f)
                curveTo(117.3f, 43.5f, 99.0f, 34.0f, 78.0f, 34.0f)
                ...
                arcTo(341.88f, 341.88f, 0.0f, false, true, 134.0f, 205.56f)
                lineTo(134.0f, 73.28f)
                curveTo(140.0f, 59.5f, 152.76f, 49.88f, 169.1f, 46.82f)
                close()
                moveTo(122.0f, 205.54f)
                curveTo(97.4f, 190.51f, 30.0f, 144.7f, 30.0f, 94.0f)
                arcTo(48.05f, 48.05f, 0.0f, false, true, 78.0f, 46.0f)
                curveToRelative(19.87f, 0.0f, 36.62f, 10.4f, 44.0f, 27.22f)
                close()
                moveTo(232.33f, 94.0f)
                ...
                arcTo(6.0f, 6.0f, 0.0f, false, true, 232.33f, 94.0f)
                close()
                moveTo(228.67f, 130.72f)
