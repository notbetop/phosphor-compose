...
public val DuotoneGroup.Gauge: ImageVector
    get() {
        if (_gauge != null) {
            return _gauge!!
        }
        _gauge = Builder(name = "Gauge", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(111.24f, 111.24f, 0.0f, false, false, 128.0f, 48.0f)
                horizontalLineToRelative(-0.4f)
                curveTo(66.07f, 48.21f, 16.0f, 99.0f, 16.0f, 161.13f)
                ...
                verticalLineTo(64.33f)
                arcTo(96.14f, 96.14f, 0.0f, false, true, 221.0f, 136.0f)
