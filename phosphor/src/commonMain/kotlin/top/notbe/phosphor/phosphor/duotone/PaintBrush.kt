...
public val DuotoneGroup.PaintBrush: ImageVector
    get() {
        if (_paintBrush != null) {
            return _paintBrush!!
        }
        _paintBrush = Builder(name = "PaintBrush", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(224.0f, 32.0f)
                curveToRelative(0.0f, 32.81f, -31.64f, 67.43f, -58.64f, 91.05f)
                arcTo(84.39f, 84.39f, 0.0f, false, false, 133.0f, 90.64f)
                curveTo(156.57f, 63.64f, 191.19f, 32.0f, 224.0f, 32.0f)
                close()
            }
