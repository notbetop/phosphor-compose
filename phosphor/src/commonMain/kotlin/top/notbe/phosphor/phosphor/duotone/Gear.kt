...
public val DuotoneGroup.Gear: ImageVector
    get() {
        if (_gear != null) {
            return _gear!!
        }
        _gear = Builder(name = "Gear", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineToRelative(16.78f, -21.0f)
                arcToRelative(99.14f, 99.14f, 0.0f, false, false, -10.07f, -24.29f)
                lineToRelative(-26.7f, -3.0f)
                arcToRelative(81.0f, 81.0f, 0.0f, false, false, -6.81f, -6.81f)
                lineToRelative(-3.0f, -26.71f)
                arcToRelative(99.43f, 99.43f, 0.0f, false, false, -24.3f, -10.0f)
                lineToRelative(-21.0f, 16.77f)
                arcToRelative(81.59f, 81.59f, 0.0f, false, false, -9.64f, 0.0f)
                lineToRelative(-21.0f, -16.78f)
                arcTo(99.14f, 99.14f, 0.0f, false, false, 77.91f, 41.43f)
                lineToRelative(-3.0f, 26.7f)
                arcToRelative(81.0f, 81.0f, 0.0f, false, false, -6.81f, 6.81f)
                lineToRelative(-26.71f, 3.0f)
                arcToRelative(99.43f, 99.43f, 0.0f, false, false, -10.0f, 24.3f)
                lineToRelative(16.77f, 21.0f)
                arcToRelative(81.59f, 81.59f, 0.0f, false, false, 0.0f, 9.64f)
                lineToRelative(-16.78f, 21.0f)
                arcToRelative(99.14f, 99.14f, 0.0f, false, false, 10.07f, 24.29f)
                lineToRelative(26.7f, 3.0f)
                arcToRelative(81.0f, 81.0f, 0.0f, false, false, 6.81f, 6.81f)
                ...
                arcToRelative(81.59f, 81.59f, 0.0f, false, false, 9.64f, 0.0f)
                lineToRelative(21.0f, 16.78f)
                arcToRelative(99.14f, 99.14f, 0.0f, false, false, 24.29f, -10.07f)
                lineToRelative(3.0f, -26.7f)
                arcToRelative(81.0f, 81.0f, 0.0f, false, false, 6.81f, -6.81f)
                lineToRelative(26.71f, -3.0f)
                arcToRelative(99.43f, 99.43f, 0.0f, false, false, 10.0f, -24.3f)
                lineToRelative(-16.77f, -21.0f)
                arcTo(81.59f, 81.59f, 0.0f, false, false, 207.86f, 123.18f)
                close()
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.06f, 8.06f, 0.0f, false, false, -5.48f, 1.74f)
