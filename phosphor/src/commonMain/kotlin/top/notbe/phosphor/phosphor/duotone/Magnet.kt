...
public val DuotoneGroup.Magnet: ImageVector
    get() {
        if (_magnet != null) {
            return _magnet!!
        }
        _magnet = Builder(name = "Magnet", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(168.36f, 200.36f)
                lineToRelative(-30.0f, 29.35f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.26f, -0.05f)
                lineTo(98.46f, 201.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.08f, -11.4f)
                lineToRelative(30.0f, -29.0f)
                close()
                moveTo(26.36f, 117.6f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 11.28f)
                lineTo(55.0f, 157.54f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.38f, -0.06f)
                lineToRelative(29.18f, -29.92f)
                lineTo(55.77f, 87.77f)
                close()
            }
