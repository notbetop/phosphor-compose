    ...
    get() {
        ...
        _rug = Builder(name = "Rug", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 5.14f, -2.91f)
                lineToRelative(24.0f, -40.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, -6.18f)
                lineToRelative(-24.0f, -40.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -10.28f, 0.0f)
                lineToRelative(-24.0f, 40.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, 0.0f, 6.18f)
                lineToRelative(24.0f, 40.0f)
                arcTo(6.0f, 6.0f, 0.0f, false, false, 128.0f, 174.0f)
                close()
                moveTo(128.0f, 99.66f)
                lineTo(145.0f, 128.0f)
                lineToRelative(-17.0f, 28.34f)
