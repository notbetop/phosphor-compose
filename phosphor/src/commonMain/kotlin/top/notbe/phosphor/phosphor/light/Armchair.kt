    ...
    get() {
        ...
        _armchair = Builder(name = "Armchair", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(90.48f)
                arcTo(38.05f, 38.05f, 0.0f, false, false, 170.0f, 128.0f)
                verticalLineToRelative(2.0f)
                horizontalLineTo(86.0f)
                verticalLineToRelative(-2.0f)
                arcTo(38.05f, 38.05f, 0.0f, false, false, 54.0f, 90.48f)
                verticalLineTo(72.0f)
                arcTo(26.0f, 26.0f, 0.0f, false, true, 80.0f, 46.0f)
                close()
                moveTo(208.35f, 154.0f)
                ...
                arcToRelative(26.0f, 26.0f, 0.0f, true, true, 26.35f, 26.0f)
                close()
            }
        }
        .build()
