...
public val FillGroup.AirTrafficControl: ImageVector
    get() {
        ...
        _airTrafficControl = Builder(name = "AirTrafficControl", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 102.52f, 143.87f)
                close()
                moveTo(173.0f, 81.43f)
                lineToRelative(-10.19f, 56.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.86f, 6.57f)
                arcToRelative(7.87f, 7.87f, 0.0f, false, true, -1.44f, -0.13f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.44f, -9.3f)
                lineToRelative(10.18f, -56.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 173.0f, 81.43f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 160.0f, 180.0f)
                close()
            }
        }
        .build()
