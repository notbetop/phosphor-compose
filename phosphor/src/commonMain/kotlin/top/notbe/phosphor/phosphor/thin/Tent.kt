...
public val ThinGroup.Tent: ImageVector
    get() {
        if (_tent != null) {
            return _tent!!
        }
        _tent = Builder(name = "Tent", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(251.66f, 198.38f)
                lineToRelative(-64.0f, -144.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, false, 184.0f, 52.0f)
                lineTo(72.0f, 52.0f)
                ...
                moveTo(68.0f, 74.85f)
                lineTo(68.0f, 196.0f)
                lineTo(14.16f, 196.0f)
                close()
                moveTo(76.0f, 196.0f)
                lineTo(76.0f, 74.85f)
                lineTo(129.84f, 196.0f)
                close()
                moveTo(138.6f, 196.0f)
                lineTo(78.16f, 60.0f)
                lineTo(181.4f, 60.0f)
