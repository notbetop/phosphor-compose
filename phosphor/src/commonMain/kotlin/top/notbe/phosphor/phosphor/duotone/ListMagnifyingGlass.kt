...
public val DuotoneGroup.ListMagnifyingGlass: ImageVector
    get() {
        ...
        _listMagnifyingGlass = Builder(name = "ListMagnifyingGlass", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, true, 216.0f, 144.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -16.0f)
                close()
                moveTo(237.66f, 197.66f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, 0.0f)
                lineTo(206.0f, 177.36f)
                arcTo(40.0f, 40.0f, 0.0f, true, true, 217.36f, 166.0f)
                lineToRelative(20.3f, 20.3f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 237.66f, 197.66f)
                close()
                moveTo(184.0f, 168.0f)
                arcToRelative(24.0f, 24.0f, 0.0f, true, false, -24.0f, -24.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 184.0f, 168.0f)
                close()
            }
        }
        .build()
