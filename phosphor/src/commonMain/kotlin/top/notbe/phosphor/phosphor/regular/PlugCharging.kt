...
public val RegularGroup.PlugCharging: ImageVector
    get() {
        ...
        _plugCharging = Builder(name = "PlugCharging", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(192.0f, 72.0f)
                verticalLineToRelative(88.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, true, 168.0f, 184.0f)
                close()
                moveTo(150.58f, 123.44f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 150.58f, 123.44f)
                close()
            }
        }
        .build()
