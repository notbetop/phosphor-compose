    ...
    get() {
        ...
        _keyboard = Builder(name = "Keyboard", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(223.51f, 52.0f)
                horizontalLineToRelative(-191.0f)
                arcTo(12.5f, 12.5f, 0.0f, false, false, 20.0f, 64.49f)
                verticalLineToRelative(127.0f)
                arcTo(12.5f, 12.5f, 0.0f, false, false, 32.49f, 204.0f)
                horizontalLineToRelative(191.0f)
                arcTo(12.5f, 12.5f, 0.0f, false, false, 236.0f, 191.51f)
                verticalLineToRelative(-127.0f)
                arcTo(12.5f, 12.5f, 0.0f, false, false, 223.51f, 52.0f)
                close()
                moveTo(228.0f, 191.51f)
                arcToRelative(4.49f, 4.49f, 0.0f, false, true, -4.49f, 4.49f)
                horizontalLineToRelative(-191.0f)
                arcTo(4.49f, 4.49f, 0.0f, false, true, 28.0f, 191.51f)
                verticalLineToRelative(-127.0f)
                arcTo(4.49f, 4.49f, 0.0f, false, true, 32.49f, 60.0f)
                horizontalLineToRelative(191.0f)
                arcTo(4.49f, 4.49f, 0.0f, false, true, 228.0f, 64.49f)
                close()
