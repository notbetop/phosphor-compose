...
public val DuotoneGroup.Cat: ImageVector
    get() {
        if (_cat != null) {
            return _cat!!
        }
        _cat = Builder(name = "Cat", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 48.6f, -43.0f, 88.0f, -96.0f, 88.0f)
                reflectiveCurveToRelative(-96.0f, -39.4f, -96.0f, -88.0f)
                verticalLineTo(48.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 13.66f, -5.66f)
                lineTo(67.6f, 67.6f)
                horizontalLineToRelative(0.0f)
                arcToRelative(102.87f, 102.87f, 0.0f, false, true, 120.8f, 0.0f)
                horizontalLineToRelative(0.0f)
