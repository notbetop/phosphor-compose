...
public val DuotoneGroup.Lighthouse: ImageVector
    get() {
        if (_lighthouse != null) {
            return _lighthouse!!
        }
        _lighthouse = Builder(name = "Lighthouse", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(181.61f, 112.0f)
                horizontalLineTo(74.39f)
                lineTo(80.0f, 56.0f)
                horizontalLineToRelative(96.0f)
                close()
                moveTo(192.0f, 215.24f)
                lineTo(187.23f, 168.0f)
                horizontalLineTo(68.77f)
                lineTo(64.0f, 215.24f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 72.0f, 224.0f)
                horizontalLineTo(184.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 192.0f, 215.24f)
                close()
            }
