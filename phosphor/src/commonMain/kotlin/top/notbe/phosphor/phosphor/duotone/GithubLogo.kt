...
public val DuotoneGroup.GithubLogo: ImageVector
    get() {
        if (_githubLogo != null) {
            return _githubLogo!!
        }
        _githubLogo = Builder(name = "GithubLogo", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(48.0f, 48.0f, 0.0f, false, true, -48.0f, -48.0f)
                verticalLineToRelative(-8.0f)
                arcToRelative(49.28f, 49.28f, 0.0f, false, true, 8.51f, -27.3f)
                arcTo(51.92f, 51.92f, 0.0f, false, true, 76.0f, 32.0f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, 43.83f, 24.0f)
                horizontalLineToRelative(32.34f)
                arcTo(52.0f, 52.0f, 0.0f, false, true, 196.0f, 32.0f)
                arcToRelative(51.92f, 51.92f, 0.0f, false, true, 3.49f, 44.7f)
                arcTo(49.28f, 49.28f, 0.0f, false, true, 208.0f, 104.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(208.3f, 75.68f)
                arcTo(59.74f, 59.74f, 0.0f, false, false, 202.93f, 28.0f)
                ...
                verticalLineToRelative(-8.0f)
                arcTo(58.0f, 58.0f, 0.0f, false, false, 208.3f, 75.68f)
                close()
                ...
                arcTo(41.76f, 41.76f, 0.0f, false, true, 200.0f, 104.0f)
                close()
            }
        }
        .build()
