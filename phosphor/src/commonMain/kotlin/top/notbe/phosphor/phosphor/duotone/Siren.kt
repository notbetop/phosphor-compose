...
public val DuotoneGroup.Siren: ImageVector
    get() {
        if (_siren != null) {
            return _siren!!
        }
        _siren = Builder(name = "Siren", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(208.0f, 129.0f)
                verticalLineToRelative(39.0f)
                horizontalLineTo(48.0f)
                verticalLineTo(128.0f)
                arcToRelative(80.0f, 80.0f, 0.0f, false, true, 80.61f, -80.0f)
                curveTo(172.72f, 48.33f, 208.0f, 84.89f, 208.0f, 129.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, 16.0f, -16.0f)
                lineTo(40.0f, 128.0f)
                arcToRelative(88.0f, 88.0f, 0.0f, false, true, 88.0f, -88.0f)
